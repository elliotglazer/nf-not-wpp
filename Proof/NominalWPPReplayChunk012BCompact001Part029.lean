...
import NominalWPPReplayChunk012BCompact001Part028
...
noncomputable def g_brdisjg
    (A : Class) (B : Class) (V : Class) (W : Class) :
    Nominal.NPrf (.imp (syn_wa (.classMem A V) (.classMem B W)) (syn_wb (syn_wbr A (syn_cdisj) B) (.classEq (syn_cin A B) (syn_c0)))) := by
  ...
  have dv_cache_0006 : x ∉ ((Wff.classEq (syn_cin A B) (syn_c0))).fv := by
  ...
  have dv_cache_0007 : y ∉ ((Wff.classEq (syn_cin A B) (syn_c0))).fv := by
  ...
  have p0000 :=
    @g_ineq1 (.cv x) A (.cv y)
  have p0001 :=
    @g_eqeq1d (.classEq (.cv x) A) (syn_cin (.cv x) (.cv y)) (syn_cin A (.cv y)) (syn_c0) p0000
  have p0002 :=
    @g_ineq2 (.cv y) B A
  have p0003 :=
  ...
  have p0005 :=
    @g_brabg (.classEq (syn_cin (.cv x) (.cv y)) (syn_c0)) (.classEq (syn_cin A (.cv y)) (syn_c0)) (.classEq (syn_cin A B) (syn_c0)) x y A B V W (syn_cdisj) dv_cache_0002 dv_cache_0003 dv_cache_0004 dv_cache_0005 dv_cache_0006 dv_cache_0007 dv_cache_0001 p0001 p0003 p0004
  exact p0005

#print axioms g_brdisjg

...
import NominalWPPReplayChunk015Compact001Part021
...
noncomputable def g_hnwcutclassinjndv
    (x : Var) (y : Var) (D : Class) (R : Class) (hyp_hnwcutclassinjndv_1 : Nominal.NPrf (syn_wbr R (syn_cwe) D)) :
  ...
  have p0003 :=
    @g_wppweconnex D R
  have p0004 :=
    Nominal.mp hyp_hnwcutclassinjndv_1 p0003
  have p0005 :=
  ...
  have p0059 :=
    @g_hnwcutclassltnendv x y D R hyp_hnwcutclassinjndv_1
  have p0060 :=
  ...
  have p0067 :=
    @g_hnwcutclassltnendv y x D R hyp_hnwcutclassinjndv_1
  have p0068 :=
...
noncomputable def g_hnwcutclassinjclndv
    (B : Class) (C : Class) (D : Class) (R : Class) (hyp_hnwcutclassinjclndv_1 : Nominal.NPrf (syn_wbr R (syn_cwe) D)) :
  ...
  have dv_cache_0006 : y ∉ ((Wff.imp (syn_wa (.classMem B D) (.classMem C D)) (.imp (.classEq (syn_cec (syn_chnwcutcode R D B) (syn_chwniso D)) (syn_cec (syn_chnwcutcode R D C) (syn_chwniso D))) (.classEq B C)))).fv := by
  ...
  have dv_cache_0007 : x ∉ ((Wff.imp (syn_wa (.classMem B D) (.classMem (.cv y) D)) (.imp (.classEq (syn_cec (syn_chnwcutcode R D B) (syn_chwniso D)) (syn_cec (syn_chnwcutcode R D (.cv y)) (syn_chwniso D))) (.classEq B (.cv y))))).fv := by
...
noncomputable def g_lnkereq
    (R : Class) (S : Class) :
    Nominal.NPrf (.imp (.classEq R S) (.classEq (syn_clnker R) (syn_clnker S))) := by
  ...
  have p0001 :=
    @g_cnveq R S
  have p0002 :=
    @g_ineq12d (.classEq R S) R S (syn_ccnv R) (syn_ccnv S) p0000 p0001
  have p0003 :=
    (by simpa [syn_clnker] using (Nominal.classEqRefl (syn_clnker R)))
  have p0004 :=
    (by simpa [syn_clnker] using (Nominal.classEqRefl (syn_clnker S)))
  have p0005 :=
    @g_n_3eqtr4g (.classEq R S) (syn_cin R (syn_ccnv R)) (syn_cin S (syn_ccnv S)) (syn_clnker R) (syn_clnker S) p0002 p0003 p0004
  exact p0005

noncomputable def g_lnanbi12ni
    (ph : Wff) (ps : Wff) (ch : Wff) (th : Wff) (hyp_lnanbi12ni_1 : Nominal.NPrf (syn_wb ph ps)) (hyp_lnanbi12ni_2 : Nominal.NPrf (syn_wb ch th)) :
    Nominal.NPrf (syn_wb (syn_wa ph (.neg ch)) (syn_wa ps (.neg th))) := by
  let proofSupport : Finset Var := ph.fv ∪ ps.fv ∪ ch.fv ∪ th.fv
  have p0000 :=
    @g_notbii ch th hyp_lnanbi12ni_2
  have p0001 :=
    @g_anbi12i ph ps (.neg ch) (.neg th) hyp_lnanbi12ni_1 p0000
  exact p0001

noncomputable def g_lndifopvalg
    (A : Class) (B : Class) (V : Class) (W : Class) :
    Nominal.NPrf (.imp (syn_wa (.classMem A V) (.classMem B W)) (.classEq (syn_co A (syn_clndifop) B) (syn_cdif A B))) := by
  ...
  have dv_cache_0007 : y ∉ ((syn_cvv)).fv := by
    ...
    exact (by
      have compact_fv_not_mem_empty : y ∉ (∅ : Finset Var) := by
        ...
        cases hmem
      simp only [NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_cvv, Finset.mem_union, Finset.mem_erase, Finset.mem_insert, Finset.mem_singleton, compact_fv_not_mem_empty, false_or, or_false, true_and, and_true, false_and, and_false, not_false_eq_true])
  have dv_cache_0008 : x ∉ ((syn_cdif A (.cv y))).fv := by
    clear dv_cache_0001 dv_cache_0002 dv_cache_0003 dv_cache_0004 dv_cache_0005 dv_cache_0006 dv_cache_0007
    exact (by
      have compact_fv_not_mem_empty : x ∉ (∅ : Finset Var) := by
        intro hmem
        cases hmem
      simp only [NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_cdif, NFChoice.Compiler.CoreFVSimp.fv_class_cv, Finset.mem_union, Finset.mem_erase, Finset.mem_insert, Finset.mem_singleton, fresh_x_not_A, fresh_x_ne_y, compact_fv_not_mem_empty, false_or, or_false, true_and, and_true, false_and, and_false, not_false_eq_true])
  have dv_cache_0009 : x ∉ ((syn_cdif A B)).fv := by
  ...
  have dv_cache_0010 : y ∉ ((syn_cdif A B)).fv := by
    clear dv_cache_0001 dv_cache_0002 dv_cache_0003 dv_cache_0004 dv_cache_0005 dv_cache_0006 dv_cache_0007 dv_cache_0008 dv_cache_0009
    exact (by
      have compact_fv_not_mem_empty : y ∉ (∅ : Finset Var) := by
        intro hmem
        cases hmem
      simp only [NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_cdif, Finset.mem_union, Finset.mem_erase, Finset.mem_insert, Finset.mem_singleton, fresh_y_not_A, fresh_y_not_B, compact_fv_not_mem_empty, false_or, or_false, true_and, and_true, false_and, and_false, not_false_eq_true])
  have p0000 :=
    @g_elex A V
  have p0001 :=
    @g_elex B W
  ...
  have p0003 :=
    @g_difeq1 (.cv x) A (.cv y)
  have p0004 :=
    @g_difeq2 (.cv y) B A
  have p0005 :=
    NFChoice.DirectNominalPrf.NominalAlphaWrappersRepaired.nominal_df_lndifop x y dv_cache_0001
  have p0006 :=
    @g_ovmpt2g x y A B (syn_cvv) (syn_cvv) (syn_cdif (.cv x) (.cv y)) (syn_cdif A B) (syn_clndifop) (syn_cdif A (.cv y)) (syn_cvv) dv_cache_0002 dv_cache_0003 dv_cache_0004 dv_cache_0005 dv_cache_0006 dv_cache_0007 dv_cache_0006 dv_cache_0007 dv_cache_0008 dv_cache_0009 dv_cache_0010 dv_cache_0001 p0003 p0004 p0005
  have p0007 :=
    @g_mpd3an3 (.classMem A (syn_cvv)) (.classMem B (syn_cvv)) (.classMem (syn_cdif A B) (syn_cvv)) (.classEq (syn_co A (syn_clndifop) B) (syn_cdif A B)) p0002 p0006
  have p0008 :=
    @g_syl2an (.classMem A V) (.classMem A (syn_cvv)) (.classMem B (syn_cvv)) (.classEq (syn_co A (syn_clndifop) B) (syn_cdif A B)) (.classMem B W) p0000 p0001 p0007
  exact p0008

noncomputable def g_fnlndifop
     :
    Nominal.NPrf (syn_wfn (syn_clndifop) (syn_cvv)) := by
  ...
  have p0002 :=
    @g_vex y
  have p0003 :=
    @g_difex (.cv x) (.cv y) p0001 p0002
  have p0004 :=
    @g_fnmpt2i x y (syn_cvv) (syn_cvv) (syn_cdif (.cv x) (.cv y)) (syn_clndifop) dv_cache_0002 dv_cache_0003 dv_cache_0002 dv_cache_0003 dv_cache_0001 p0000 p0003
  have p0005 :=
    @g_xpvv
  have p0006 :=
    @g_fneq2i (syn_cxp (syn_cvv) (syn_cvv)) (syn_cvv) (syn_clndifop) p0005
  have p0007 :=
    @g_mpbi (syn_wfn (syn_clndifop) (syn_cxp (syn_cvv) (syn_cvv))) (syn_wfn (syn_clndifop) (syn_cvv)) p0004 p0006
  exact p0007

#print axioms g_fnlndifop

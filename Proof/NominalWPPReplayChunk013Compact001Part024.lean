...
import NominalWPPReplayChunk013Compact001Part023
...
noncomputable def g_frd
    (ph : Wff) (y : Var) (z : Var) (A : Class) (R : Class) (V : Class) (X : Class) (dv_R_y : y ∉ R.fv) (dv_R_z : z ∉ R.fv) (dv_X_y : y ∉ X.fv) (dv_X_z : z ∉ X.fv) (dv_y_z : y ≠ z) (hyp_frd_1 : Nominal.NPrf (.imp ph (syn_wbr R (syn_cfound) A))) (hyp_frd_2 : Nominal.NPrf (.imp ph (.classMem X V))) (hyp_frd_3 : Nominal.NPrf (.imp ph (syn_wss X A))) (hyp_frd_4 : Nominal.NPrf (.imp ph (syn_wne X (syn_c0)))) :
    Nominal.NPrf (.imp ph (syn_wrex y X (syn_wral z X (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y))))) := by
  let proofSupport : Finset Var := ph.fv ∪ ({y} : Finset Var) ∪ ({z} : Finset Var) ∪ A.fv ∪ R.fv ∪ V.fv ∪ X.fv
  ...
  have dv_cache_0002 : z ∉ ((Wff.classEq (.cv r) R)).fv := by
    clear dv_cache_0001
    exact (by
  ...
  have dv_cache_0003 : x ∉ ((Wff.classEq (.cv r) R)).fv := by
  ...
  have dv_cache_0004 : x ∉ ((Wff.classEq (.cv a) A)).fv := by
    clear dv_cache_0001 dv_cache_0002 dv_cache_0003
    exact (by
      have compact_fv_not_mem_empty : x ∉ (∅ : Finset Var) := by
        intro hmem
        cases hmem
      simp only [NFChoice.Compiler.CoreFVSimp.fv_wff_classEq, NFChoice.Compiler.CoreFVSimp.fv_class_cv, Finset.mem_union, Finset.mem_erase, Finset.mem_insert, Finset.mem_singleton, fresh_x_ne_a, fresh_x_not_A, compact_fv_not_mem_empty, false_or, or_false, true_and, and_true, false_and, and_false, not_false_eq_true])
  ...
  have dv_cache_0019 : r ∉ ((Wff.all x (.imp (syn_wa (syn_wss (.cv x) A) (syn_wne (.cv x) (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y))))))).fv := by
    clear dv_cache_0001 dv_cache_0002 dv_cache_0003 dv_cache_0004 dv_cache_0005 dv_cache_0006 dv_cache_0007 dv_cache_0008 dv_cache_0009 dv_cache_0010 dv_cache_0011 dv_cache_0012 dv_cache_0013 dv_cache_0014 dv_cache_0015 dv_cache_0016 dv_cache_0017 dv_cache_0018
    exact (by
      have compact_fv_not_mem_empty : r ∉ (∅ : Finset Var) := by
        intro hmem
        cases hmem
      simp only [NFChoice.Compiler.CoreFVSimp.fv_wff_all, NFChoice.Compiler.CoreFVSimp.fv_wff_imp, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wa, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wss, NFChoice.Compiler.CoreFVSimp.fv_class_cv, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wne, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_c0, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wrex, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wral, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wbr, NFChoice.Compiler.CoreFVSimp.fv_wff_objEq, Finset.mem_union, Finset.mem_erase, Finset.mem_insert, Finset.mem_singleton, fresh_r_ne_x, fresh_r_not_A, fresh_r_ne_z, fresh_r_ne_y, fresh_r_not_R, compact_fv_not_mem_empty, false_or, or_false, true_and, and_true, false_and, and_false, not_false_eq_true])
  have dv_cache_0020 : a ∉ ((Wff.all x (.imp (syn_wa (syn_wss (.cv x) A) (syn_wne (.cv x) (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y))))))).fv := by
    clear dv_cache_0001 dv_cache_0002 dv_cache_0003 dv_cache_0004 dv_cache_0005 dv_cache_0006 dv_cache_0007 dv_cache_0008 dv_cache_0009 dv_cache_0010 dv_cache_0011 dv_cache_0012 dv_cache_0013 dv_cache_0014 dv_cache_0015 dv_cache_0016 dv_cache_0017 dv_cache_0018 dv_cache_0019
    exact (by
      have compact_fv_not_mem_empty : a ∉ (∅ : Finset Var) := by
        intro hmem
        cases hmem
      simp only [NFChoice.Compiler.CoreFVSimp.fv_wff_all, NFChoice.Compiler.CoreFVSimp.fv_wff_imp, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wa, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wss, NFChoice.Compiler.CoreFVSimp.fv_class_cv, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wne, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_c0, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wrex, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wral, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wbr, NFChoice.Compiler.CoreFVSimp.fv_wff_objEq, Finset.mem_union, Finset.mem_erase, Finset.mem_insert, Finset.mem_singleton, fresh_a_ne_x, fresh_a_not_A, fresh_a_ne_z, fresh_a_ne_y, fresh_a_not_R, compact_fv_not_mem_empty, false_or, or_false, true_and, and_true, false_and, and_false, not_false_eq_true])
  ...
  have dv_cache_0022 : z ∉ ((Class.cv x)).fv := by
  ...
  have dv_cache_0024 : y ∉ ((Class.cv x)).fv := by
  ...
  have dv_cache_0027 : x ∉ ((Wff.imp (syn_wa (syn_wss X A) (syn_wne X (syn_c0))) (syn_wrex y X (syn_wral z X (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y)))))).fv := by
    clear dv_cache_0001 dv_cache_0002 dv_cache_0003 dv_cache_0004 dv_cache_0005 dv_cache_0006 dv_cache_0007 dv_cache_0008 dv_cache_0009 dv_cache_0010 dv_cache_0011 dv_cache_0012 dv_cache_0013 dv_cache_0014 dv_cache_0015 dv_cache_0016 dv_cache_0017 dv_cache_0018 dv_cache_0019 dv_cache_0020 dv_cache_0021 dv_cache_0022 dv_cache_0023 dv_cache_0024 dv_cache_0025 dv_cache_0026
    exact (by
      have compact_fv_not_mem_empty : x ∉ (∅ : Finset Var) := by
        intro hmem
        cases hmem
      simp only [NFChoice.Compiler.CoreFVSimp.fv_wff_imp, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wa, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wss, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wne, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_c0, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wrex, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wral, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wbr, NFChoice.Compiler.CoreFVSimp.fv_class_cv, NFChoice.Compiler.CoreFVSimp.fv_wff_objEq, Finset.mem_union, Finset.mem_erase, Finset.mem_insert, Finset.mem_singleton, fresh_x_not_X, fresh_x_not_A, fresh_x_ne_z, fresh_x_ne_y, fresh_x_not_R, compact_fv_not_mem_empty, false_or, or_false, true_and, and_true, false_and, and_false, not_false_eq_true])
  have p0000 :=
    @g_brex R A (syn_cfound)
  have p0001 :=
    @g_breq (.cv z) (.cv y) (.cv r) R
  have p0002 :=
    @g_imbi1d (.classEq (.cv r) R) (syn_wbr (.cv z) (.cv r) (.cv y)) (syn_wbr (.cv z) R (.cv y)) (.objEq z y) p0001
  have p0003 :=
    @g_rexralbidv (.classEq (.cv r) R) (.imp (syn_wbr (.cv z) (.cv r) (.cv y)) (.objEq z y)) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y)) y z (.cv x) (.cv x) dv_cache_0001 dv_cache_0002 p0002
  have p0004 :=
    @g_imbi2d (.classEq (.cv r) R) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) (.cv r) (.cv y)) (.objEq z y)))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y)))) (syn_wa (syn_wss (.cv x) (.cv a)) (syn_wne (.cv x) (syn_c0))) p0003
  have p0005 :=
    @g_albidv (.classEq (.cv r) R) (.imp (syn_wa (syn_wss (.cv x) (.cv a)) (syn_wne (.cv x) (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) (.cv r) (.cv y)) (.objEq z y))))) (.imp (syn_wa (syn_wss (.cv x) (.cv a)) (syn_wne (.cv x) (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y))))) x dv_cache_0003 p0004
  have p0006 :=
    @g_sseq2 (.cv a) A (.cv x)
  have p0007 :=
    @g_anbi1d (.classEq (.cv a) A) (syn_wss (.cv x) (.cv a)) (syn_wss (.cv x) A) (syn_wne (.cv x) (syn_c0)) p0006
  have p0008 :=
    @g_imbi1d (.classEq (.cv a) A) (syn_wa (syn_wss (.cv x) (.cv a)) (syn_wne (.cv x) (syn_c0))) (syn_wa (syn_wss (.cv x) A) (syn_wne (.cv x) (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y)))) p0007
  have p0009 :=
    @g_albidv (.classEq (.cv a) A) (.imp (syn_wa (syn_wss (.cv x) (.cv a)) (syn_wne (.cv x) (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y))))) (.imp (syn_wa (syn_wss (.cv x) A) (syn_wne (.cv x) (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y))))) x dv_cache_0004 p0008
  have p0010 :=
    NFChoice.DirectNominalPrf.NominalAlphaWrappersRepaired.nominal_df_found x z y r a dv_cache_0005 dv_cache_0006 dv_cache_0007 dv_cache_0008 dv_cache_0009 dv_cache_0010 dv_cache_0011 dv_cache_0012 dv_cache_0013 dv_cache_0014
  have p0011 :=
    @g_brabg (.all x (.imp (syn_wa (syn_wss (.cv x) (.cv a)) (syn_wne (.cv x) (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) (.cv r) (.cv y)) (.objEq z y)))))) (.all x (.imp (syn_wa (syn_wss (.cv x) (.cv a)) (syn_wne (.cv x) (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y)))))) (.all x (.imp (syn_wa (syn_wss (.cv x) A) (syn_wne (.cv x) (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y)))))) r a R A (syn_cvv) (syn_cvv) (syn_cfound) dv_cache_0015 dv_cache_0016 dv_cache_0017 dv_cache_0018 dv_cache_0019 dv_cache_0020 dv_cache_0021 p0005 p0009 p0010
  have p0012 :=
    @g_syl (syn_wbr R (syn_cfound) A) (syn_wa (.classMem R (syn_cvv)) (.classMem A (syn_cvv))) (syn_wb (syn_wbr R (syn_cfound) A) (.all x (.imp (syn_wa (syn_wss (.cv x) A) (syn_wne (.cv x) (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y))))))) p0000 p0011
  have p0013 :=
    @g_ibi (syn_wbr R (syn_cfound) A) (.all x (.imp (syn_wa (syn_wss (.cv x) A) (syn_wne (.cv x) (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y)))))) p0012
  have p0014 :=
    @g_syl ph (syn_wbr R (syn_cfound) A) (.all x (.imp (syn_wa (syn_wss (.cv x) A) (syn_wne (.cv x) (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y)))))) hyp_frd_1 p0013
  have p0015 :=
    @g_sseq1 (.cv x) X A
  have p0016 :=
    @g_neeq1 (.cv x) X (syn_c0)
  have p0017 :=
    @g_anbi12d (.classEq (.cv x) X) (syn_wss (.cv x) A) (syn_wss X A) (syn_wne (.cv x) (syn_c0)) (syn_wne X (syn_c0)) p0015 p0016
  have p0018 :=
    @g_raleq (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y)) z (.cv x) X dv_cache_0022 dv_cache_0023
  have p0019 :=
    @g_rexeqbi1dv (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y))) (syn_wral z X (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y))) y (.cv x) X dv_cache_0024 dv_cache_0025 p0018
  have p0020 :=
    @g_imbi12d (.classEq (.cv x) X) (syn_wa (syn_wss (.cv x) A) (syn_wne (.cv x) (syn_c0))) (syn_wa (syn_wss X A) (syn_wne X (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y)))) (syn_wrex y X (syn_wral z X (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y)))) p0017 p0019
  have p0021 :=
    @g_spcgv (.imp (syn_wa (syn_wss (.cv x) A) (syn_wne (.cv x) (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y))))) (.imp (syn_wa (syn_wss X A) (syn_wne X (syn_c0))) (syn_wrex y X (syn_wral z X (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y))))) x X V dv_cache_0026 dv_cache_0027 p0020
  have p0022 :=
    @g_sylc ph (.classMem X V) (.all x (.imp (syn_wa (syn_wss (.cv x) A) (syn_wne (.cv x) (syn_c0))) (syn_wrex y (.cv x) (syn_wral z (.cv x) (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y)))))) (.imp (syn_wa (syn_wss X A) (syn_wne X (syn_c0))) (syn_wrex y X (syn_wral z X (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y))))) hyp_frd_2 p0014 p0021
  have p0023 :=
    @g_mp2and ph (syn_wss X A) (syn_wne X (syn_c0)) (syn_wrex y X (syn_wral z X (.imp (syn_wbr (.cv z) R (.cv y)) (.objEq z y)))) hyp_frd_3 hyp_frd_4 p0022
  exact p0023

noncomputable def g_symd
    (ph : Wff) (A : Class) (R : Class) (X : Class) (Y : Class) (hyp_symd_1 : Nominal.NPrf (.imp ph (syn_wbr R (syn_csym) A))) (hyp_symd_2 : Nominal.NPrf (.imp ph (.classMem X A))) (hyp_symd_3 : Nominal.NPrf (.imp ph (.classMem Y A))) (hyp_symd_4 : Nominal.NPrf (.imp ph (syn_wbr X R Y))) :
  ...
  have dv_cache_0016 : a ∉ (A).fv := by
    ...
    exact (by
      have compact_fv_not_mem_empty : a ∉ (∅ : Finset Var) := by
        ...
        cases hmem
      simp only [Finset.mem_union, Finset.mem_erase, Finset.mem_insert, Finset.mem_singleton, fresh_a_not_A, compact_fv_not_mem_empty, false_or, or_false, true_and, and_true, false_and, and_false, not_false_eq_true])
  have dv_cache_0017 : r ∉ ((syn_wral x A (syn_wral y A (.imp (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv x)))))).fv := by
    clear dv_cache_0001 dv_cache_0002 dv_cache_0003 dv_cache_0004 dv_cache_0005 dv_cache_0006 dv_cache_0007 dv_cache_0008 dv_cache_0009 dv_cache_0010 dv_cache_0011 dv_cache_0012 dv_cache_0013 dv_cache_0014 dv_cache_0015 dv_cache_0016
    exact (by
      have compact_fv_not_mem_empty : r ∉ (∅ : Finset Var) := by
        intro hmem
  ...
  have dv_cache_0018 : a ∉ ((syn_wral x A (syn_wral y A (.imp (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv x)))))).fv := by
    clear dv_cache_0001 dv_cache_0002 dv_cache_0003 dv_cache_0004 dv_cache_0005 dv_cache_0006 dv_cache_0007 dv_cache_0008 dv_cache_0009 dv_cache_0010 dv_cache_0011 dv_cache_0012 dv_cache_0013 dv_cache_0014 dv_cache_0015 dv_cache_0016 dv_cache_0017
    exact (by
      have compact_fv_not_mem_empty : a ∉ (∅ : Finset Var) := by
        intro hmem
  ...
  have dv_cache_0023 : x ∉ ((Wff.imp (syn_wbr X R (.cv y)) (syn_wbr (.cv y) R X))).fv := by
    clear dv_cache_0001 dv_cache_0002 dv_cache_0003 dv_cache_0004 dv_cache_0005 dv_cache_0006 dv_cache_0007 dv_cache_0008 dv_cache_0009 dv_cache_0010 dv_cache_0011 dv_cache_0012 dv_cache_0013 dv_cache_0014 dv_cache_0015 dv_cache_0016 dv_cache_0017 dv_cache_0018 dv_cache_0019 dv_cache_0020 dv_cache_0021 dv_cache_0022
    exact (by
      have compact_fv_not_mem_empty : x ∉ (∅ : Finset Var) := by
        intro hmem
        cases hmem
      simp only [NFChoice.Compiler.CoreFVSimp.fv_wff_imp, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wbr, NFChoice.Compiler.CoreFVSimp.fv_class_cv, Finset.mem_union, Finset.mem_erase, Finset.mem_insert, Finset.mem_singleton, fresh_x_not_X, fresh_x_ne_y, fresh_x_not_R, compact_fv_not_mem_empty, false_or, or_false, true_and, and_true, false_and, and_false, not_false_eq_true])
  have dv_cache_0024 : y ∉ ((Wff.imp (syn_wbr X R Y) (syn_wbr Y R X))).fv := by
    clear dv_cache_0001 dv_cache_0002 dv_cache_0003 dv_cache_0004 dv_cache_0005 dv_cache_0006 dv_cache_0007 dv_cache_0008 dv_cache_0009 dv_cache_0010 dv_cache_0011 dv_cache_0012 dv_cache_0013 dv_cache_0014 dv_cache_0015 dv_cache_0016 dv_cache_0017 dv_cache_0018 dv_cache_0019 dv_cache_0020 dv_cache_0021 dv_cache_0022 dv_cache_0023
    exact (by
      have compact_fv_not_mem_empty : y ∉ (∅ : Finset Var) := by
        intro hmem
        cases hmem
      simp only [NFChoice.Compiler.CoreFVSimp.fv_wff_imp, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wbr, Finset.mem_union, Finset.mem_erase, Finset.mem_insert, Finset.mem_singleton, fresh_y_not_X, fresh_y_not_Y, fresh_y_not_R, compact_fv_not_mem_empty, false_or, or_false, true_and, and_true, false_and, and_false, not_false_eq_true])
  have p0000 :=
    @g_jca ph (.classMem X A) (.classMem Y A) hyp_symd_2 hyp_symd_3
  have p0001 :=
    @g_brex R A (syn_csym)
  have p0002 :=
  ...
  have p0005 :=
    @g_n_2ralbidv (.classEq (.cv r) R) (.imp (syn_wbr (.cv x) (.cv r) (.cv y)) (syn_wbr (.cv y) (.cv r) (.cv x))) (.imp (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv x))) x y (.cv a) (.cv a) dv_cache_0001 dv_cache_0002 p0004
  have p0006 :=
    @g_raleq (.imp (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv x))) y (.cv a) A dv_cache_0003 dv_cache_0004
  have p0007 :=
    @g_raleqbi1dv (syn_wral y (.cv a) (.imp (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv x)))) (syn_wral y A (.imp (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv x)))) x (.cv a) A dv_cache_0005 dv_cache_0006 p0006
  have p0008 :=
    NFChoice.DirectNominalPrf.NominalAlphaWrappersRepaired.nominal_df_sym x y r a dv_cache_0007 dv_cache_0008 dv_cache_0009 dv_cache_0010 dv_cache_0011 dv_cache_0012
  have p0009 :=
    @g_brabg (syn_wral x (.cv a) (syn_wral y (.cv a) (.imp (syn_wbr (.cv x) (.cv r) (.cv y)) (syn_wbr (.cv y) (.cv r) (.cv x))))) (syn_wral x (.cv a) (syn_wral y (.cv a) (.imp (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv x))))) (syn_wral x A (syn_wral y A (.imp (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv x))))) r a R A (syn_cvv) (syn_cvv) (syn_csym) dv_cache_0013 dv_cache_0014 dv_cache_0015 dv_cache_0016 dv_cache_0017 dv_cache_0018 dv_cache_0019 p0005 p0007 p0008
  have p0010 :=
    @g_syl (syn_wbr R (syn_csym) A) (syn_wa (.classMem R (syn_cvv)) (.classMem A (syn_cvv))) (syn_wb (syn_wbr R (syn_csym) A) (syn_wral x A (syn_wral y A (.imp (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv x)))))) p0001 p0009
  have p0011 :=
    @g_ibi (syn_wbr R (syn_csym) A) (syn_wral x A (syn_wral y A (.imp (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv x))))) p0010
  have p0012 :=
    @g_syl ph (syn_wbr R (syn_csym) A) (syn_wral x A (syn_wral y A (.imp (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv x))))) hyp_symd_1 p0011
  have p0013 :=
    @g_breq1 (.cv x) X (.cv y) R
  have p0014 :=
    @g_breq2 (.cv x) X (.cv y) R
  have p0015 :=
    @g_imbi12d (.classEq (.cv x) X) (syn_wbr (.cv x) R (.cv y)) (syn_wbr X R (.cv y)) (syn_wbr (.cv y) R (.cv x)) (syn_wbr (.cv y) R X) p0013 p0014
  have p0016 :=
    @g_breq2 (.cv y) Y X R
  have p0017 :=
    @g_breq1 (.cv y) Y X R
  have p0018 :=
    @g_imbi12d (.classEq (.cv y) Y) (syn_wbr X R (.cv y)) (syn_wbr X R Y) (syn_wbr (.cv y) R X) (syn_wbr Y R X) p0016 p0017
  have p0019 :=
    @g_rspc2v (.imp (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv x))) (.imp (syn_wbr X R Y) (syn_wbr Y R X)) (.imp (syn_wbr X R (.cv y)) (syn_wbr (.cv y) R X)) x y X Y A A dv_cache_0020 dv_cache_0021 dv_cache_0022 dv_cache_0006 dv_cache_0006 dv_cache_0004 dv_cache_0023 dv_cache_0024 dv_cache_0012 p0015 p0018
  have p0020 :=
    @g_syl3c ph (syn_wa (.classMem X A) (.classMem Y A)) (syn_wral x A (syn_wral y A (.imp (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv x))))) (syn_wbr X R Y) (syn_wbr Y R X) p0000 p0012 hyp_symd_4 p0019
  exact p0020

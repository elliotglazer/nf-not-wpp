...
noncomputable def nominal_df_xp
    (x : Var) (y : Var) (A : Class) (B : Class) (dv_A_x : x ∉ A.fv) (dv_A_y : y ∉ A.fv) (dv_B_x : x ∉ B.fv) (dv_B_y : y ∉ B.fv) (dv_x_y : x ≠ y) :
    Nominal.NPrf (.classEq (syn_cxp A B) (syn_copab x y (syn_wa (.classMem (.cv x) A) (.classMem (.cv y) B)))) := by
  let alpha_dummy_000 : Var := (freshVar ((A).fv ∪ (B).fv) 0)
  let alpha_dummy_001 : Var := (freshVar ((A).fv ∪ (B).fv) 1)
  let alpha_dummy_002 : Var := (freshVar (({alpha_dummy_000} : Finset Var) ∪ ({alpha_dummy_001} : Finset Var) ∪ ((syn_wa (Wff.classMem (Class.cv alpha_dummy_000) A) (Wff.classMem (Class.cv alpha_dummy_001) B))).fv) 0)
  let alpha_dummy_003 : Var := (freshVar (({x} : Finset Var) ∪ ({y} : Finset Var) ∪ ((syn_wa (Wff.classMem (Class.cv x) A) (Wff.classMem (Class.cv y) B))).fv) 0)
  ...
  have fresh_049 : alpha_dummy_002 ∉ (({alpha_dummy_000} : Finset Var) ∪ ({alpha_dummy_001} : Finset Var) ∪ ((syn_wa (Wff.classMem (Class.cv alpha_dummy_000) A) (Wff.classMem (Class.cv alpha_dummy_001) B))).fv) := by
    simpa [alpha_dummy_002] using freshVar_not_mem (({alpha_dummy_000} : Finset Var) ∪ ({alpha_dummy_001} : Finset Var) ∪ ((syn_wa (Wff.classMem (Class.cv alpha_dummy_000) A) (Wff.classMem (Class.cv alpha_dummy_001) B))).fv) 0
  have fresh_050 : alpha_dummy_003 ∉ (({x} : Finset Var) ∪ ({y} : Finset Var) ∪ ((syn_wa (Wff.classMem (Class.cv x) A) (Wff.classMem (Class.cv y) B))).fv) := by
    simpa [alpha_dummy_003] using freshVar_not_mem (({x} : Finset Var) ∪ ({y} : Finset Var) ∪ ((syn_wa (Wff.classMem (Class.cv x) A) (Wff.classMem (Class.cv y) B))).fv) 0
  have support_mem_0000 : alpha_dummy_000 ∈ (({alpha_dummy_000} : Finset Var) ∪ ({alpha_dummy_001} : Finset Var) ∪ ((syn_wa (Wff.classMem (Class.cv alpha_dummy_000) A) (Wff.classMem (Class.cv alpha_dummy_001) B))).fv) := by
    apply Finset.mem_union_left
    apply Finset.mem_union_left
    exact Finset.mem_singleton_self _
  have support_mem_0001 : x ∈ (({x} : Finset Var) ∪ ({y} : Finset Var) ∪ ((syn_wa (Wff.classMem (Class.cv x) A) (Wff.classMem (Class.cv y) B))).fv) := by
    apply Finset.mem_union_left
    apply Finset.mem_union_left
    exact Finset.mem_singleton_self _
  have support_mem_0002 : alpha_dummy_001 ∈ (({alpha_dummy_000} : Finset Var) ∪ ({alpha_dummy_001} : Finset Var) ∪ ((syn_wa (Wff.classMem (Class.cv alpha_dummy_000) A) (Wff.classMem (Class.cv alpha_dummy_001) B))).fv) := by
    apply Finset.mem_union_left
    apply Finset.mem_union_right
    exact Finset.mem_singleton_self _
  have support_mem_0003 : y ∈ (({x} : Finset Var) ∪ ({y} : Finset Var) ∪ ((syn_wa (Wff.classMem (Class.cv x) A) (Wff.classMem (Class.cv y) B))).fv) := by
    apply Finset.mem_union_left
    apply Finset.mem_union_right
    exact Finset.mem_singleton_self _
  ...
  have focused_notmem_0000 : alpha_dummy_002 ∉ A.fv := by
    change freshVar (({alpha_dummy_000} : Finset Var) ∪ ({alpha_dummy_001} : Finset Var) ∪ ((syn_wa (Wff.classMem (Class.cv alpha_dummy_000) A) (Wff.classMem (Class.cv alpha_dummy_001) B))).fv) 0 ∉ A.fv
    exact NFChoice.DefinitionLeaves.AlphaFocusedSupport.freshVar_not_mem_of_subset 0 (fun u hu => Finset.mem_union_right _ (((fv_syn_wa (Wff.classMem (Class.cv alpha_dummy_000) A) (Wff.classMem (Class.cv alpha_dummy_001) B)).symm ▸ (Finset.mem_union_left _ (((fv_wff_classMem (Class.cv alpha_dummy_000) A).symm ▸ (Finset.mem_union_right _ (hu))))))))
  have wpp_notmem_0106 : alpha_dummy_002 ∉ (A).fv := by
    exact focused_notmem_0000
  have focused_notmem_0001 : alpha_dummy_003 ∉ A.fv := by
    change freshVar (({x} : Finset Var) ∪ ({y} : Finset Var) ∪ ((syn_wa (Wff.classMem (Class.cv x) A) (Wff.classMem (Class.cv y) B))).fv) 0 ∉ A.fv
    exact NFChoice.DefinitionLeaves.AlphaFocusedSupport.freshVar_not_mem_of_subset 0 (fun u hu => Finset.mem_union_right _ (((fv_syn_wa (Wff.classMem (Class.cv x) A) (Wff.classMem (Class.cv y) B)).symm ▸ (Finset.mem_union_left _ (((fv_wff_classMem (Class.cv x) A).symm ▸ (Finset.mem_union_right _ (hu))))))))
  have wpp_notmem_0107 : alpha_dummy_003 ∉ (A).fv := by
  ...
  have wpp_notmem_0108 : alpha_dummy_000 ∉ (A).fv := by
    exact focused_notmem_0002
  have wpp_notmem_0109 : x ∉ (A).fv := by
    exact dv_A_x
  ...
  have wpp_notmem_0110 : alpha_dummy_001 ∉ (A).fv := by
    exact focused_notmem_0003
  have wpp_notmem_0111 : y ∉ (A).fv := by
    exact dv_A_y
  have wpp_refl_0007 : TReflOn [(alpha_dummy_001, y), (alpha_dummy_000, x), (alpha_dummy_002, alpha_dummy_003)] (A).fv := by
    intro u hu
    exact (TAlphaVar.there (fun h_eq => (wpp_notmem_0110) (h_eq ▸ hu)) (fun h_eq => (wpp_notmem_0111) (h_eq ▸ hu)) (TAlphaVar.there (fun h_eq => (wpp_notmem_0108) (h_eq ▸ hu)) (fun h_eq => (wpp_notmem_0109) (h_eq ▸ hu)) (TAlphaVar.there (fun h_eq => (wpp_notmem_0106) (h_eq ▸ hu)) (fun h_eq => (wpp_notmem_0107) (h_eq ▸ hu)) (TAlphaVar.free (by simp) (by simp)))))
  have focused_notmem_0004 : alpha_dummy_002 ∉ B.fv := by
    change freshVar (({alpha_dummy_000} : Finset Var) ∪ ({alpha_dummy_001} : Finset Var) ∪ ((syn_wa (Wff.classMem (Class.cv alpha_dummy_000) A) (Wff.classMem (Class.cv alpha_dummy_001) B))).fv) 0 ∉ B.fv
    exact NFChoice.DefinitionLeaves.AlphaFocusedSupport.freshVar_not_mem_of_subset 0 (fun u hu => Finset.mem_union_right _ (((fv_syn_wa (Wff.classMem (Class.cv alpha_dummy_000) A) (Wff.classMem (Class.cv alpha_dummy_001) B)).symm ▸ (Finset.mem_union_right _ (((fv_wff_classMem (Class.cv alpha_dummy_001) B).symm ▸ (Finset.mem_union_right _ (hu))))))))
  have wpp_notmem_0112 : alpha_dummy_002 ∉ (B).fv := by
    exact focused_notmem_0004
  have focused_notmem_0005 : alpha_dummy_003 ∉ B.fv := by
    change freshVar (({x} : Finset Var) ∪ ({y} : Finset Var) ∪ ((syn_wa (Wff.classMem (Class.cv x) A) (Wff.classMem (Class.cv y) B))).fv) 0 ∉ B.fv
    exact NFChoice.DefinitionLeaves.AlphaFocusedSupport.freshVar_not_mem_of_subset 0 (fun u hu => Finset.mem_union_right _ (((fv_syn_wa (Wff.classMem (Class.cv x) A) (Wff.classMem (Class.cv y) B)).symm ▸ (Finset.mem_union_right _ (((fv_wff_classMem (Class.cv y) B).symm ▸ (Finset.mem_union_right _ (hu))))))))
  have wpp_notmem_0113 : alpha_dummy_003 ∉ (B).fv := by
    exact focused_notmem_0005
  have focused_notmem_0006 : alpha_dummy_000 ∉ B.fv := by
  ...
  have wpp_notmem_0114 : alpha_dummy_000 ∉ (B).fv := by
    exact focused_notmem_0006
  have wpp_notmem_0115 : x ∉ (B).fv := by
    exact dv_B_x
  have focused_notmem_0007 : alpha_dummy_001 ∉ B.fv := by
  ...
  have wpp_notmem_0116 : alpha_dummy_001 ∉ (B).fv := by
    exact focused_notmem_0007
  have wpp_notmem_0117 : y ∉ (B).fv := by
    exact dv_B_y
  have wpp_refl_0008 : TReflOn [(alpha_dummy_001, y), (alpha_dummy_000, x), (alpha_dummy_002, alpha_dummy_003)] (B).fv := by
    intro u hu
    exact (TAlphaVar.there (fun h_eq => (wpp_notmem_0116) (h_eq ▸ hu)) (fun h_eq => (wpp_notmem_0117) (h_eq ▸ hu)) (TAlphaVar.there (fun h_eq => (wpp_notmem_0114) (h_eq ▸ hu)) (fun h_eq => (wpp_notmem_0115) (h_eq ▸ hu)) (TAlphaVar.there (fun h_eq => (wpp_notmem_0112) (h_eq ▸ hu)) (fun h_eq => (wpp_notmem_0113) (h_eq ▸ hu)) (TAlphaVar.free (by simp) (by simp)))))
  exact Nominal.alphaClassEq (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp split_alpha_0004 (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.there (freshVar_injective ((A).fv ∪ (B).fv) (by decide)) dv_x_y (TAlphaVar.here _ _ _))) (TAlphaClass.refl_of_reflOn [(alpha_dummy_001, y), (alpha_dummy_000, x), (alpha_dummy_002, alpha_dummy_003)] A wpp_refl_0007)) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.refl_of_reflOn [(alpha_dummy_001, y), (alpha_dummy_000, x), (alpha_dummy_002, alpha_dummy_003)] B wpp_refl_0008)))))))))))))))

...
import NominalWPPReplayChunk013Compact001Part022
...
noncomputable def g_partialex
     :
    Nominal.NPrf (.classMem (syn_cpartial) (syn_cvv)) := by
  ...
  have p0002 :=
    @g_transex
  have p0003 :=
    @g_inex (syn_cref) (syn_ctrans) p0001 p0002
  have p0004 :=
    @g_antisymex
  have p0005 :=
    @g_inex (syn_cin (syn_cref) (syn_ctrans)) (syn_cantisym) p0003 p0004
  have p0006 :=
    @g_eqeltri (syn_cpartial) (syn_cin (syn_cin (syn_cref) (syn_ctrans)) (syn_cantisym)) (syn_cvv) p0000 p0005
  exact p0006

noncomputable def g_strictex
     :
    Nominal.NPrf (.classMem (syn_cstrict) (syn_cvv)) := by
  let proofSupport : Finset Var := (∅ : Finset Var)
  have p0000 :=
  ...
  have p0002 :=
    @g_connexex
  have p0003 :=
    @g_inex (syn_cpartial) (syn_cconnex) p0001 p0002
  have p0004 :=
    @g_eqeltri (syn_cstrict) (syn_cin (syn_cpartial) (syn_cconnex)) (syn_cvv) p0000 p0003
  exact p0004

noncomputable def g_weex
     :
    Nominal.NPrf (.classMem (syn_cwe) (syn_cvv)) := by
  let proofSupport : Finset Var := (∅ : Finset Var)
  have p0000 :=
  ...
  have p0002 :=
    @g_foundex
  have p0003 :=
    @g_inex (syn_cstrict) (syn_cfound) p0001 p0002
  have p0004 :=
    @g_eqeltri (syn_cwe) (syn_cin (syn_cstrict) (syn_cfound)) (syn_cvv) p0000 p0003
  exact p0004

noncomputable def g_trd
    (ph : Wff) (A : Class) (R : Class) (X : Class) (Y : Class) (Z : Class) (hyp_trd_1 : Nominal.NPrf (.imp ph (syn_wbr R (syn_ctrans) A))) (hyp_trd_2 : Nominal.NPrf (.imp ph (.classMem X A))) (hyp_trd_3 : Nominal.NPrf (.imp ph (.classMem Y A))) (hyp_trd_4 : Nominal.NPrf (.imp ph (.classMem Z A))) (hyp_trd_5 : Nominal.NPrf (.imp ph (syn_wbr X R Y))) (hyp_trd_6 : Nominal.NPrf (.imp ph (syn_wbr Y R Z))) :
  ...
  have dv_cache_0001 : z ∉ ((Wff.classEq (.cv r) R)).fv := by
    exact (by
      have compact_fv_not_mem_empty : z ∉ (∅ : Finset Var) := by
        intro hmem
        cases hmem
      simp only [NFChoice.Compiler.CoreFVSimp.fv_wff_classEq, NFChoice.Compiler.CoreFVSimp.fv_class_cv, Finset.mem_union, Finset.mem_erase, Finset.mem_insert, Finset.mem_singleton, fresh_z_ne_r, fresh_z_not_R, compact_fv_not_mem_empty, false_or, or_false, true_and, and_true, false_and, and_false, not_false_eq_true])
  ...
  have dv_cache_0003 : y ∉ ((Wff.classEq (.cv r) R)).fv := by
  ...
  have dv_cache_0024 : r ∉ ((syn_wral x A (syn_wral y A (syn_wral z A (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z))))))).fv := by
  ...
  have dv_cache_0025 : a ∉ ((syn_wral x A (syn_wral y A (syn_wral z A (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z))))))).fv := by
  ...
  have dv_cache_0033 : x ∉ ((Wff.imp (syn_wa (syn_wbr X R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr X R (.cv z)))).fv := by
    clear dv_cache_0001 dv_cache_0002 dv_cache_0003 dv_cache_0004 dv_cache_0005 dv_cache_0006 dv_cache_0007 dv_cache_0008 dv_cache_0009 dv_cache_0010 dv_cache_0011 dv_cache_0012 dv_cache_0013 dv_cache_0014 dv_cache_0015 dv_cache_0016 dv_cache_0017 dv_cache_0018 dv_cache_0019 dv_cache_0020 dv_cache_0021 dv_cache_0022 dv_cache_0023 dv_cache_0024 dv_cache_0025 dv_cache_0026 dv_cache_0027 dv_cache_0028 dv_cache_0029 dv_cache_0030 dv_cache_0031 dv_cache_0032
    exact (by
      have compact_fv_not_mem_empty : x ∉ (∅ : Finset Var) := by
        intro hmem
        cases hmem
      simp only [NFChoice.Compiler.CoreFVSimp.fv_wff_imp, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wa, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wbr, NFChoice.Compiler.CoreFVSimp.fv_class_cv, Finset.mem_union, Finset.mem_erase, Finset.mem_insert, Finset.mem_singleton, fresh_x_not_X, fresh_x_ne_y, fresh_x_not_R, fresh_x_ne_z, compact_fv_not_mem_empty, false_or, or_false, true_and, and_true, false_and, and_false, not_false_eq_true])
  have dv_cache_0034 : z ∉ ((Wff.imp (syn_wa (syn_wbr X R Y) (syn_wbr Y R Z)) (syn_wbr X R Z))).fv := by
    clear dv_cache_0001 dv_cache_0002 dv_cache_0003 dv_cache_0004 dv_cache_0005 dv_cache_0006 dv_cache_0007 dv_cache_0008 dv_cache_0009 dv_cache_0010 dv_cache_0011 dv_cache_0012 dv_cache_0013 dv_cache_0014 dv_cache_0015 dv_cache_0016 dv_cache_0017 dv_cache_0018 dv_cache_0019 dv_cache_0020 dv_cache_0021 dv_cache_0022 dv_cache_0023 dv_cache_0024 dv_cache_0025 dv_cache_0026 dv_cache_0027 dv_cache_0028 dv_cache_0029 dv_cache_0030 dv_cache_0031 dv_cache_0032 dv_cache_0033
    exact (by
      have compact_fv_not_mem_empty : z ∉ (∅ : Finset Var) := by
        intro hmem
        cases hmem
      simp only [NFChoice.Compiler.CoreFVSimp.fv_wff_imp, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wa, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wbr, Finset.mem_union, Finset.mem_erase, Finset.mem_insert, Finset.mem_singleton, fresh_z_not_X, fresh_z_not_Y, fresh_z_not_R, fresh_z_not_Z, compact_fv_not_mem_empty, false_or, or_false, true_and, and_true, false_and, and_false, not_false_eq_true])
  have dv_cache_0035 : y ∉ ((Wff.imp (syn_wa (syn_wbr X R Y) (syn_wbr Y R (.cv z))) (syn_wbr X R (.cv z)))).fv := by
    clear dv_cache_0001 dv_cache_0002 dv_cache_0003 dv_cache_0004 dv_cache_0005 dv_cache_0006 dv_cache_0007 dv_cache_0008 dv_cache_0009 dv_cache_0010 dv_cache_0011 dv_cache_0012 dv_cache_0013 dv_cache_0014 dv_cache_0015 dv_cache_0016 dv_cache_0017 dv_cache_0018 dv_cache_0019 dv_cache_0020 dv_cache_0021 dv_cache_0022 dv_cache_0023 dv_cache_0024 dv_cache_0025 dv_cache_0026 dv_cache_0027 dv_cache_0028 dv_cache_0029 dv_cache_0030 dv_cache_0031 dv_cache_0032 dv_cache_0033 dv_cache_0034
    exact (by
      have compact_fv_not_mem_empty : y ∉ (∅ : Finset Var) := by
        intro hmem
        cases hmem
      simp only [NFChoice.Compiler.CoreFVSimp.fv_wff_imp, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wa, NFChoice.Compiler.CompactSyntaxFVExplicit.fv_syn_wbr, NFChoice.Compiler.CoreFVSimp.fv_class_cv, Finset.mem_union, Finset.mem_erase, Finset.mem_insert, Finset.mem_singleton, fresh_y_not_X, fresh_y_not_Y, fresh_y_not_R, fresh_y_ne_z, compact_fv_not_mem_empty, false_or, or_false, true_and, and_true, false_and, and_false, not_false_eq_true])
  have p0000 :=
    @g_brex R A (syn_ctrans)
  have p0001 :=
    @g_breq (.cv x) (.cv y) (.cv r) R
  have p0002 :=
    @g_breq (.cv y) (.cv z) (.cv r) R
  have p0003 :=
    @g_anbi12d (.classEq (.cv r) R) (syn_wbr (.cv x) (.cv r) (.cv y)) (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) (.cv r) (.cv z)) (syn_wbr (.cv y) R (.cv z)) p0001 p0002
  have p0004 :=
    @g_breq (.cv x) (.cv z) (.cv r) R
  have p0005 :=
    @g_imbi12d (.classEq (.cv r) R) (syn_wa (syn_wbr (.cv x) (.cv r) (.cv y)) (syn_wbr (.cv y) (.cv r) (.cv z))) (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) (.cv r) (.cv z)) (syn_wbr (.cv x) R (.cv z)) p0003 p0004
  have p0006 :=
    @g_ralbidv (.classEq (.cv r) R) (.imp (syn_wa (syn_wbr (.cv x) (.cv r) (.cv y)) (syn_wbr (.cv y) (.cv r) (.cv z))) (syn_wbr (.cv x) (.cv r) (.cv z))) (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z))) z (.cv a) dv_cache_0001 p0005
  have p0007 :=
    @g_n_2ralbidv (.classEq (.cv r) R) (syn_wral z (.cv a) (.imp (syn_wa (syn_wbr (.cv x) (.cv r) (.cv y)) (syn_wbr (.cv y) (.cv r) (.cv z))) (syn_wbr (.cv x) (.cv r) (.cv z)))) (syn_wral z (.cv a) (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z)))) x y (.cv a) (.cv a) dv_cache_0002 dv_cache_0003 p0006
  have p0008 :=
    @g_raleq (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z))) z (.cv a) A dv_cache_0004 dv_cache_0005
  have p0009 :=
    @g_raleqbi1dv (syn_wral z (.cv a) (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z)))) (syn_wral z A (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z)))) y (.cv a) A dv_cache_0006 dv_cache_0007 p0008
  have p0010 :=
    @g_raleqbi1dv (syn_wral y (.cv a) (syn_wral z (.cv a) (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z))))) (syn_wral y A (syn_wral z A (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z))))) x (.cv a) A dv_cache_0008 dv_cache_0009 p0009
  have p0011 :=
    NFChoice.DirectNominalPrf.NominalAlphaWrappersRepaired.nominal_df_trans x y z r a dv_cache_0010 dv_cache_0011 dv_cache_0012 dv_cache_0013 dv_cache_0014 dv_cache_0015 dv_cache_0016 dv_cache_0017 dv_cache_0018 dv_cache_0019
  have p0012 :=
    @g_brabg (syn_wral x (.cv a) (syn_wral y (.cv a) (syn_wral z (.cv a) (.imp (syn_wa (syn_wbr (.cv x) (.cv r) (.cv y)) (syn_wbr (.cv y) (.cv r) (.cv z))) (syn_wbr (.cv x) (.cv r) (.cv z)))))) (syn_wral x (.cv a) (syn_wral y (.cv a) (syn_wral z (.cv a) (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z)))))) (syn_wral x A (syn_wral y A (syn_wral z A (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z)))))) r a R A (syn_cvv) (syn_cvv) (syn_ctrans) dv_cache_0020 dv_cache_0021 dv_cache_0022 dv_cache_0023 dv_cache_0024 dv_cache_0025 dv_cache_0026 p0007 p0010 p0011
  have p0013 :=
    @g_syl (syn_wbr R (syn_ctrans) A) (syn_wa (.classMem R (syn_cvv)) (.classMem A (syn_cvv))) (syn_wb (syn_wbr R (syn_ctrans) A) (syn_wral x A (syn_wral y A (syn_wral z A (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z))))))) p0000 p0012
  have p0014 :=
    @g_ibi (syn_wbr R (syn_ctrans) A) (syn_wral x A (syn_wral y A (syn_wral z A (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z)))))) p0013
  have p0015 :=
    @g_syl ph (syn_wbr R (syn_ctrans) A) (syn_wral x A (syn_wral y A (syn_wral z A (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z)))))) hyp_trd_1 p0014
  have p0016 :=
    @g_breq1 (.cv x) X (.cv y) R
  have p0017 :=
    @g_anbi1d (.classEq (.cv x) X) (syn_wbr (.cv x) R (.cv y)) (syn_wbr X R (.cv y)) (syn_wbr (.cv y) R (.cv z)) p0016
  have p0018 :=
    @g_breq1 (.cv x) X (.cv z) R
  have p0019 :=
    @g_imbi12d (.classEq (.cv x) X) (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wa (syn_wbr X R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z)) (syn_wbr X R (.cv z)) p0017 p0018
  have p0020 :=
    @g_breq2 (.cv y) Y X R
  have p0021 :=
    @g_breq1 (.cv y) Y (.cv z) R
  have p0022 :=
    @g_anbi12d (.classEq (.cv y) Y) (syn_wbr X R (.cv y)) (syn_wbr X R Y) (syn_wbr (.cv y) R (.cv z)) (syn_wbr Y R (.cv z)) p0020 p0021
  have p0023 :=
    @g_imbi1d (.classEq (.cv y) Y) (syn_wa (syn_wbr X R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wa (syn_wbr X R Y) (syn_wbr Y R (.cv z))) (syn_wbr X R (.cv z)) p0022
  have p0024 :=
    @g_breq2 (.cv z) Z Y R
  have p0025 :=
    @g_anbi2d (.classEq (.cv z) Z) (syn_wbr Y R (.cv z)) (syn_wbr Y R Z) (syn_wbr X R Y) p0024
  have p0026 :=
    @g_breq2 (.cv z) Z X R
  have p0027 :=
    @g_imbi12d (.classEq (.cv z) Z) (syn_wa (syn_wbr X R Y) (syn_wbr Y R (.cv z))) (syn_wa (syn_wbr X R Y) (syn_wbr Y R Z)) (syn_wbr X R (.cv z)) (syn_wbr X R Z) p0025 p0026
  have p0028 :=
    @g_rspc3v (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z))) (.imp (syn_wa (syn_wbr X R Y) (syn_wbr Y R Z)) (syn_wbr X R Z)) (.imp (syn_wa (syn_wbr X R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr X R (.cv z))) (.imp (syn_wa (syn_wbr X R Y) (syn_wbr Y R (.cv z))) (syn_wbr X R (.cv z))) x y z X Y Z A A A dv_cache_0027 dv_cache_0028 dv_cache_0029 dv_cache_0030 dv_cache_0031 dv_cache_0032 dv_cache_0009 dv_cache_0009 dv_cache_0007 dv_cache_0009 dv_cache_0007 dv_cache_0005 dv_cache_0033 dv_cache_0034 dv_cache_0035 dv_cache_0017 dv_cache_0018 dv_cache_0019 p0019 p0023 p0027
  have p0029 :=
    @g_syl3anc ph (.classMem X A) (.classMem Y A) (.classMem Z A) (.imp (syn_wral x A (syn_wral y A (syn_wral z A (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z)))))) (.imp (syn_wa (syn_wbr X R Y) (syn_wbr Y R Z)) (syn_wbr X R Z))) hyp_trd_2 hyp_trd_3 hyp_trd_4 p0028
  have p0030 :=
    @g_mpd ph (syn_wral x A (syn_wral y A (syn_wral z A (.imp (syn_wa (syn_wbr (.cv x) R (.cv y)) (syn_wbr (.cv y) R (.cv z))) (syn_wbr (.cv x) R (.cv z)))))) (.imp (syn_wa (syn_wbr X R Y) (syn_wbr Y R Z)) (syn_wbr X R Z)) p0015 p0029
  have p0031 :=

...
noncomputable def nominal_df_xpk
    ...
    Nominal.NPrf (.classEq (syn_cxpk A B) (.cab x (syn_wex y (syn_wex z (syn_wa (.classEq (.cv x) (syn_copk (.cv y) (.cv z))) (syn_wa (.classMem (.cv y) A) (.classMem (.cv z) B))))))) := by
  ...
  have fresh_005 : alpha_dummy_016 ∉ (((syn_ccompl (syn_csn (Class.cv y)))).fv ∪ ((syn_ccompl (syn_csn (Class.cv z)))).fv) := by
    simpa [alpha_dummy_016] using freshVar_not_mem (((syn_ccompl (syn_csn (Class.cv y)))).fv ∪ ((syn_ccompl (syn_csn (Class.cv z)))).fv) 0
  have fresh_006 : alpha_dummy_003 ∉ (((syn_ccompl (syn_csn (syn_csn (Class.cv alpha_dummy_001))))).fv ∪ ((syn_ccompl (syn_csn (syn_cpr (Class.cv alpha_dummy_001) (Class.cv alpha_dummy_002))))).fv) := by
  ...
  have fresh_007 : alpha_dummy_004 ∉ (((syn_ccompl (syn_csn (syn_csn (Class.cv y))))).fv ∪ ((syn_ccompl (syn_csn (syn_cpr (Class.cv y) (Class.cv z))))).fv) := by
  ...
  have fresh_008 : alpha_dummy_013 ∉ (((syn_cpr (Class.cv alpha_dummy_001) (Class.cv alpha_dummy_002))).fv) := by
    simpa [alpha_dummy_013] using freshVar_not_mem (((syn_cpr (Class.cv alpha_dummy_001) (Class.cv alpha_dummy_002))).fv) 0
  have fresh_009 : alpha_dummy_014 ∉ (((syn_cpr (Class.cv y) (Class.cv z))).fv) := by
    simpa [alpha_dummy_014] using freshVar_not_mem (((syn_cpr (Class.cv y) (Class.cv z))).fv) 0
  have fresh_010 : alpha_dummy_007 ∉ (((syn_csn (Class.cv alpha_dummy_001))).fv) := by
    simpa [alpha_dummy_007] using freshVar_not_mem (((syn_csn (Class.cv alpha_dummy_001))).fv) 0
  have fresh_011 : alpha_dummy_017 ∉ (((syn_csn (Class.cv alpha_dummy_001))).fv ∪ ((syn_csn (Class.cv alpha_dummy_001))).fv) := by
    simpa [alpha_dummy_017] using freshVar_not_mem (((syn_csn (Class.cv alpha_dummy_001))).fv ∪ ((syn_csn (Class.cv alpha_dummy_001))).fv) 0
  have fresh_012 : alpha_dummy_019 ∉ (((syn_csn (Class.cv alpha_dummy_002))).fv ∪ ((syn_csn (Class.cv alpha_dummy_002))).fv) := by
    simpa [alpha_dummy_019] using freshVar_not_mem (((syn_csn (Class.cv alpha_dummy_002))).fv ∪ ((syn_csn (Class.cv alpha_dummy_002))).fv) 0
  have fresh_013 : alpha_dummy_008 ∉ (((syn_csn (Class.cv y))).fv) := by
    simpa [alpha_dummy_008] using freshVar_not_mem (((syn_csn (Class.cv y))).fv) 0
  have fresh_014 : alpha_dummy_018 ∉ (((syn_csn (Class.cv y))).fv ∪ ((syn_csn (Class.cv y))).fv) := by
    simpa [alpha_dummy_018] using freshVar_not_mem (((syn_csn (Class.cv y))).fv ∪ ((syn_csn (Class.cv y))).fv) 0
  have fresh_015 : alpha_dummy_020 ∉ (((syn_csn (Class.cv z))).fv ∪ ((syn_csn (Class.cv z))).fv) := by
    simpa [alpha_dummy_020] using freshVar_not_mem (((syn_csn (Class.cv z))).fv ∪ ((syn_csn (Class.cv z))).fv) 0
  have fresh_016 : alpha_dummy_011 ∉ (((syn_csn (syn_cpr (Class.cv alpha_dummy_001) (Class.cv alpha_dummy_002)))).fv ∪ ((syn_csn (syn_cpr (Class.cv alpha_dummy_001) (Class.cv alpha_dummy_002)))).fv) := by
  ...
  have fresh_017 : alpha_dummy_012 ∉ (((syn_csn (syn_cpr (Class.cv y) (Class.cv z)))).fv ∪ ((syn_csn (syn_cpr (Class.cv y) (Class.cv z)))).fv) := by
  ...
  have fresh_018 : alpha_dummy_005 ∉ (((syn_csn (syn_csn (Class.cv alpha_dummy_001)))).fv ∪ ((syn_csn (syn_csn (Class.cv alpha_dummy_001)))).fv) := by
  ...
  have fresh_019 : alpha_dummy_006 ∉ (((syn_csn (syn_csn (Class.cv y)))).fv ∪ ((syn_csn (syn_csn (Class.cv y)))).fv) := by

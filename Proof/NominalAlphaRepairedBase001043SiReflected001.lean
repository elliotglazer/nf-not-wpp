...
noncomputable def nominal_df_si
    (x : Var) (y : Var) (z : Var) (w : Var) (A : Class) (dv_A_w : w ∉ A.fv) (dv_A_x : x ∉ A.fv) (dv_A_y : y ∉ A.fv) (dv_A_z : z ∉ A.fv) (dv_w_x : w ≠ x) (dv_w_y : w ≠ y) (dv_w_z : w ≠ z) (dv_x_y : x ≠ y) (dv_x_z : x ≠ z) (dv_y_z : y ≠ z) :
    Nominal.NPrf (.classEq (syn_csi A) (syn_copab x y (syn_wex z (syn_wex w (syn_w3a (.classEq (.cv x) (syn_csn (.cv z))) (.classEq (.cv y) (syn_csn (.cv w))) (syn_wbr (.cv z) A (.cv w))))))) := by
  ...
  let alpha_dummy_004 : Var := (freshVar (({alpha_dummy_001} : Finset Var) ∪ ({alpha_dummy_002} : Finset Var) ∪ ((syn_wex alpha_dummy_003 (syn_wex alpha_dummy_000 (syn_w3a (Wff.classEq (Class.cv alpha_dummy_001) (syn_csn (Class.cv alpha_dummy_003))) (Wff.classEq (Class.cv alpha_dummy_002) (syn_csn (Class.cv alpha_dummy_000))) (syn_wbr (Class.cv alpha_dummy_003) A (Class.cv alpha_dummy_000)))))).fv) 0)
  let alpha_dummy_005 : Var := (freshVar (({x} : Finset Var) ∪ ({y} : Finset Var) ∪ ((syn_wex z (syn_wex w (syn_w3a (Wff.classEq (Class.cv x) (syn_csn (Class.cv z))) (Wff.classEq (Class.cv y) (syn_csn (Class.cv w))) (syn_wbr (Class.cv z) A (Class.cv w)))))).fv) 0)
  ...
  let alpha_dummy_042 : Var := (freshVar (((Class.cv alpha_dummy_003)).fv) 0)
  let alpha_dummy_043 : Var := (freshVar (((Class.cv z)).fv) 0)
  let alpha_dummy_044 : Var := (freshVar (((Class.cv alpha_dummy_000)).fv) 0)
  let alpha_dummy_045 : Var := (freshVar (((Class.cv w)).fv) 0)
  let alpha_dummy_046 : Var := (freshVar (((Class.cv alpha_dummy_003)).fv ∪ ((Class.cv alpha_dummy_000)).fv) 0)
  let alpha_dummy_047 : Var := (freshVar (((Class.cv alpha_dummy_003)).fv ∪ ((Class.cv alpha_dummy_000)).fv) 1)
  let alpha_dummy_048 : Var := (freshVar (((Class.cv z)).fv ∪ ((Class.cv w)).fv) 0)
  let alpha_dummy_049 : Var := (freshVar (((Class.cv z)).fv ∪ ((Class.cv w)).fv) 1)
  let alpha_dummy_050 : Var := (freshVar (((syn_ccompl (Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_003) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cphi (Class.cv alpha_dummy_047))))))).fv ∪ ((syn_ccompl (Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_000) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cun (syn_cphi (Class.cv alpha_dummy_047)) (syn_csn (syn_c0c)))))))).fv) 0)
  let alpha_dummy_051 : Var := (freshVar (((syn_ccompl (Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv z) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cphi (Class.cv alpha_dummy_049))))))).fv ∪ ((syn_ccompl (Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv w) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cun (syn_cphi (Class.cv alpha_dummy_049)) (syn_csn (syn_c0c)))))))).fv) 0)
  let alpha_dummy_052 : Var := (freshVar (((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_003) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cphi (Class.cv alpha_dummy_047)))))).fv ∪ ((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_003) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cphi (Class.cv alpha_dummy_047)))))).fv) 0)
  let alpha_dummy_053 : Var := (freshVar (((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv z) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cphi (Class.cv alpha_dummy_049)))))).fv ∪ ((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv z) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cphi (Class.cv alpha_dummy_049)))))).fv) 0)
  let alpha_dummy_054 : Var := (freshVar (((Class.cv alpha_dummy_047)).fv) 0)
  let alpha_dummy_055 : Var := (freshVar (((Class.cv alpha_dummy_047)).fv) 1)
  let alpha_dummy_056 : Var := (freshVar (((Class.cv alpha_dummy_049)).fv) 0)
  let alpha_dummy_057 : Var := (freshVar (((Class.cv alpha_dummy_049)).fv) 1)
  let alpha_dummy_058 : Var := (freshVar (((Wff.classMem (Class.cv alpha_dummy_054) (syn_cnnc))).fv ∪ ((syn_cplc (Class.cv alpha_dummy_054) (syn_c1c))).fv ∪ ((Class.cv alpha_dummy_054)).fv) 0)
  let alpha_dummy_059 : Var := (freshVar (((Wff.classMem (Class.cv alpha_dummy_056) (syn_cnnc))).fv ∪ ((syn_cplc (Class.cv alpha_dummy_056) (syn_c1c))).fv ∪ ((Class.cv alpha_dummy_056)).fv) 0)
  let alpha_dummy_060 : Var := (freshVar (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) 0)
  let alpha_dummy_061 : Var := (freshVar (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) 1)
  let alpha_dummy_062 : Var := (freshVar (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) 2)
  let alpha_dummy_063 : Var := (freshVar (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) 0)
  let alpha_dummy_064 : Var := (freshVar (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) 1)
  let alpha_dummy_065 : Var := (freshVar (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) 2)
  let alpha_dummy_066 : Var := (freshVar (((syn_cnin (Class.cv alpha_dummy_061) (Class.cv alpha_dummy_062))).fv ∪ ((syn_cnin (Class.cv alpha_dummy_061) (Class.cv alpha_dummy_062))).fv) 0)
  let alpha_dummy_067 : Var := (freshVar (((syn_cnin (Class.cv alpha_dummy_064) (Class.cv alpha_dummy_065))).fv ∪ ((syn_cnin (Class.cv alpha_dummy_064) (Class.cv alpha_dummy_065))).fv) 0)
  let alpha_dummy_068 : Var := (freshVar (((Class.cv alpha_dummy_061)).fv ∪ ((Class.cv alpha_dummy_062)).fv) 0)
  let alpha_dummy_069 : Var := (freshVar (((Class.cv alpha_dummy_064)).fv ∪ ((Class.cv alpha_dummy_065)).fv) 0)
  let alpha_dummy_070 : Var := (freshVar (((syn_ccompl (Class.cv alpha_dummy_061))).fv ∪ ((syn_ccompl (Class.cv alpha_dummy_062))).fv) 0)
  let alpha_dummy_071 : Var := (freshVar (((syn_ccompl (Class.cv alpha_dummy_064))).fv ∪ ((syn_ccompl (Class.cv alpha_dummy_065))).fv) 0)
  let alpha_dummy_072 : Var := (freshVar (((Class.cv alpha_dummy_061)).fv ∪ ((Class.cv alpha_dummy_061)).fv) 0)
  let alpha_dummy_073 : Var := (freshVar (((Class.cv alpha_dummy_064)).fv ∪ ((Class.cv alpha_dummy_064)).fv) 0)
  let alpha_dummy_074 : Var := (freshVar (((Class.cv alpha_dummy_062)).fv ∪ ((Class.cv alpha_dummy_062)).fv) 0)
  let alpha_dummy_075 : Var := (freshVar (((Class.cv alpha_dummy_065)).fv ∪ ((Class.cv alpha_dummy_065)).fv) 0)
  let alpha_dummy_076 : Var := (freshVar (((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_000) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cun (syn_cphi (Class.cv alpha_dummy_047)) (syn_csn (syn_c0c))))))).fv ∪ ((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_000) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cun (syn_cphi (Class.cv alpha_dummy_047)) (syn_csn (syn_c0c))))))).fv) 0)
  let alpha_dummy_077 : Var := (freshVar (((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv w) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cun (syn_cphi (Class.cv alpha_dummy_049)) (syn_csn (syn_c0c))))))).fv ∪ ((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv w) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cun (syn_cphi (Class.cv alpha_dummy_049)) (syn_csn (syn_c0c))))))).fv) 0)
  let alpha_dummy_078 : Var := (freshVar (((syn_ccompl (syn_cphi (Class.cv alpha_dummy_047)))).fv ∪ ((syn_ccompl (syn_csn (syn_c0c)))).fv) 0)
  let alpha_dummy_079 : Var := (freshVar (((syn_ccompl (syn_cphi (Class.cv alpha_dummy_049)))).fv ∪ ((syn_ccompl (syn_csn (syn_c0c)))).fv) 0)
  let alpha_dummy_080 : Var := (freshVar (((syn_cphi (Class.cv alpha_dummy_047))).fv ∪ ((syn_cphi (Class.cv alpha_dummy_047))).fv) 0)
  let alpha_dummy_081 : Var := (freshVar (((syn_cphi (Class.cv alpha_dummy_049))).fv ∪ ((syn_cphi (Class.cv alpha_dummy_049))).fv) 0)
  ...
  have fresh_004 : alpha_dummy_076 ∉ (((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_000) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cun (syn_cphi (Class.cv alpha_dummy_047)) (syn_csn (syn_c0c))))))).fv ∪ ((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_000) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cun (syn_cphi (Class.cv alpha_dummy_047)) (syn_csn (syn_c0c))))))).fv) := by
    simpa [alpha_dummy_076] using freshVar_not_mem (((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_000) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cun (syn_cphi (Class.cv alpha_dummy_047)) (syn_csn (syn_c0c))))))).fv ∪ ((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_000) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cun (syn_cphi (Class.cv alpha_dummy_047)) (syn_csn (syn_c0c))))))).fv) 0
  have fresh_005 : alpha_dummy_052 ∉ (((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_003) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cphi (Class.cv alpha_dummy_047)))))).fv ∪ ((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_003) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cphi (Class.cv alpha_dummy_047)))))).fv) := by
    simpa [alpha_dummy_052] using freshVar_not_mem (((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_003) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cphi (Class.cv alpha_dummy_047)))))).fv ∪ ((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_003) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cphi (Class.cv alpha_dummy_047)))))).fv) 0
  have fresh_006 : alpha_dummy_077 ∉ (((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv w) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cun (syn_cphi (Class.cv alpha_dummy_049)) (syn_csn (syn_c0c))))))).fv ∪ ((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv w) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cun (syn_cphi (Class.cv alpha_dummy_049)) (syn_csn (syn_c0c))))))).fv) := by
    simpa [alpha_dummy_077] using freshVar_not_mem (((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv w) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cun (syn_cphi (Class.cv alpha_dummy_049)) (syn_csn (syn_c0c))))))).fv ∪ ((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv w) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cun (syn_cphi (Class.cv alpha_dummy_049)) (syn_csn (syn_c0c))))))).fv) 0
  have fresh_007 : alpha_dummy_053 ∉ (((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv z) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cphi (Class.cv alpha_dummy_049)))))).fv ∪ ((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv z) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cphi (Class.cv alpha_dummy_049)))))).fv) := by
    simpa [alpha_dummy_053] using freshVar_not_mem (((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv z) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cphi (Class.cv alpha_dummy_049)))))).fv ∪ ((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv z) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cphi (Class.cv alpha_dummy_049)))))).fv) 0
  have fresh_008 : alpha_dummy_044 ∉ (((Class.cv alpha_dummy_000)).fv) := by
    simpa [alpha_dummy_044] using freshVar_not_mem (((Class.cv alpha_dummy_000)).fv) 0
  have fresh_009 : alpha_dummy_006 ∉ (((Class.cv alpha_dummy_001)).fv ∪ ((Class.cv alpha_dummy_002)).fv) := by
    simpa [alpha_dummy_006] using freshVar_not_mem (((Class.cv alpha_dummy_001)).fv ∪ ((Class.cv alpha_dummy_002)).fv) 0
  have fresh_010 : alpha_dummy_007 ∉ (((Class.cv alpha_dummy_001)).fv ∪ ((Class.cv alpha_dummy_002)).fv) := by
    simpa [alpha_dummy_007] using freshVar_not_mem (((Class.cv alpha_dummy_001)).fv ∪ ((Class.cv alpha_dummy_002)).fv) 1
  have distinct_011 : alpha_dummy_006 ≠ alpha_dummy_007 := by
  ...
  have fresh_012 : alpha_dummy_042 ∉ (((Class.cv alpha_dummy_003)).fv) := by
    simpa [alpha_dummy_042] using freshVar_not_mem (((Class.cv alpha_dummy_003)).fv) 0
  have fresh_013 : alpha_dummy_046 ∉ (((Class.cv alpha_dummy_003)).fv ∪ ((Class.cv alpha_dummy_000)).fv) := by
    simpa [alpha_dummy_046] using freshVar_not_mem (((Class.cv alpha_dummy_003)).fv ∪ ((Class.cv alpha_dummy_000)).fv) 0
  have fresh_014 : alpha_dummy_047 ∉ (((Class.cv alpha_dummy_003)).fv ∪ ((Class.cv alpha_dummy_000)).fv) := by
    simpa [alpha_dummy_047] using freshVar_not_mem (((Class.cv alpha_dummy_003)).fv ∪ ((Class.cv alpha_dummy_000)).fv) 1
  have distinct_015 : alpha_dummy_046 ≠ alpha_dummy_047 := by
    simpa [alpha_dummy_046, alpha_dummy_047] using
      (freshVar_injective (((Class.cv alpha_dummy_003)).fv ∪ ((Class.cv alpha_dummy_000)).fv) (i := 0) (j := 1) (by decide))
  have fresh_016 : alpha_dummy_014 ∉ (((Class.cv alpha_dummy_007)).fv) := by
    simpa [alpha_dummy_014] using freshVar_not_mem (((Class.cv alpha_dummy_007)).fv) 0
  have fresh_017 : alpha_dummy_015 ∉ (((Class.cv alpha_dummy_007)).fv) := by
    simpa [alpha_dummy_015] using freshVar_not_mem (((Class.cv alpha_dummy_007)).fv) 1
  have distinct_018 : alpha_dummy_014 ≠ alpha_dummy_015 := by
    simpa [alpha_dummy_014, alpha_dummy_015] using
      (freshVar_injective (((Class.cv alpha_dummy_007)).fv) (i := 0) (j := 1) (by decide))
  have fresh_019 : alpha_dummy_016 ∉ (((Class.cv alpha_dummy_009)).fv) := by
    simpa [alpha_dummy_016] using freshVar_not_mem (((Class.cv alpha_dummy_009)).fv) 0
  have fresh_020 : alpha_dummy_017 ∉ (((Class.cv alpha_dummy_009)).fv) := by
    simpa [alpha_dummy_017] using freshVar_not_mem (((Class.cv alpha_dummy_009)).fv) 1
  have distinct_021 : alpha_dummy_016 ≠ alpha_dummy_017 := by
    simpa [alpha_dummy_016, alpha_dummy_017] using
      (freshVar_injective (((Class.cv alpha_dummy_009)).fv) (i := 0) (j := 1) (by decide))
  have fresh_022 : alpha_dummy_020 ∉ (((Class.cv alpha_dummy_014)).fv ∪ ((syn_c1c)).fv) := by
    simpa [alpha_dummy_020] using freshVar_not_mem (((Class.cv alpha_dummy_014)).fv ∪ ((syn_c1c)).fv) 0
  have fresh_023 : alpha_dummy_021 ∉ (((Class.cv alpha_dummy_014)).fv ∪ ((syn_c1c)).fv) := by
    simpa [alpha_dummy_021] using freshVar_not_mem (((Class.cv alpha_dummy_014)).fv ∪ ((syn_c1c)).fv) 1
  have fresh_024 : alpha_dummy_022 ∉ (((Class.cv alpha_dummy_014)).fv ∪ ((syn_c1c)).fv) := by
  ...
  have distinct_032 : alpha_dummy_023 ≠ alpha_dummy_025 := by
    simpa [alpha_dummy_023, alpha_dummy_025] using
      (freshVar_injective (((Class.cv alpha_dummy_016)).fv ∪ ((syn_c1c)).fv) (i := 0) (j := 2) (by decide))
  have distinct_033 : alpha_dummy_024 ≠ alpha_dummy_025 := by
    simpa [alpha_dummy_024, alpha_dummy_025] using
      (freshVar_injective (((Class.cv alpha_dummy_016)).fv ∪ ((syn_c1c)).fv) (i := 1) (j := 2) (by decide))
  have fresh_034 : alpha_dummy_032 ∉ (((Class.cv alpha_dummy_021)).fv ∪ ((Class.cv alpha_dummy_021)).fv) := by
    simpa [alpha_dummy_032] using freshVar_not_mem (((Class.cv alpha_dummy_021)).fv ∪ ((Class.cv alpha_dummy_021)).fv) 0
  have fresh_035 : alpha_dummy_028 ∉ (((Class.cv alpha_dummy_021)).fv ∪ ((Class.cv alpha_dummy_022)).fv) := by
    simpa [alpha_dummy_028] using freshVar_not_mem (((Class.cv alpha_dummy_021)).fv ∪ ((Class.cv alpha_dummy_022)).fv) 0
  have fresh_036 : alpha_dummy_034 ∉ (((Class.cv alpha_dummy_022)).fv ∪ ((Class.cv alpha_dummy_022)).fv) := by
    simpa [alpha_dummy_034] using freshVar_not_mem (((Class.cv alpha_dummy_022)).fv ∪ ((Class.cv alpha_dummy_022)).fv) 0
  have fresh_037 : alpha_dummy_033 ∉ (((Class.cv alpha_dummy_024)).fv ∪ ((Class.cv alpha_dummy_024)).fv) := by
    simpa [alpha_dummy_033] using freshVar_not_mem (((Class.cv alpha_dummy_024)).fv ∪ ((Class.cv alpha_dummy_024)).fv) 0
  have fresh_038 : alpha_dummy_029 ∉ (((Class.cv alpha_dummy_024)).fv ∪ ((Class.cv alpha_dummy_025)).fv) := by
    simpa [alpha_dummy_029] using freshVar_not_mem (((Class.cv alpha_dummy_024)).fv ∪ ((Class.cv alpha_dummy_025)).fv) 0
  have fresh_039 : alpha_dummy_035 ∉ (((Class.cv alpha_dummy_025)).fv ∪ ((Class.cv alpha_dummy_025)).fv) := by
    simpa [alpha_dummy_035] using freshVar_not_mem (((Class.cv alpha_dummy_025)).fv ∪ ((Class.cv alpha_dummy_025)).fv) 0
  have fresh_040 : alpha_dummy_054 ∉ (((Class.cv alpha_dummy_047)).fv) := by
    simpa [alpha_dummy_054] using freshVar_not_mem (((Class.cv alpha_dummy_047)).fv) 0
  have fresh_041 : alpha_dummy_055 ∉ (((Class.cv alpha_dummy_047)).fv) := by
    simpa [alpha_dummy_055] using freshVar_not_mem (((Class.cv alpha_dummy_047)).fv) 1
  have distinct_042 : alpha_dummy_054 ≠ alpha_dummy_055 := by
    simpa [alpha_dummy_054, alpha_dummy_055] using
      (freshVar_injective (((Class.cv alpha_dummy_047)).fv) (i := 0) (j := 1) (by decide))
  have fresh_043 : alpha_dummy_056 ∉ (((Class.cv alpha_dummy_049)).fv) := by
    simpa [alpha_dummy_056] using freshVar_not_mem (((Class.cv alpha_dummy_049)).fv) 0
  have fresh_044 : alpha_dummy_057 ∉ (((Class.cv alpha_dummy_049)).fv) := by
    simpa [alpha_dummy_057] using freshVar_not_mem (((Class.cv alpha_dummy_049)).fv) 1
  have distinct_045 : alpha_dummy_056 ≠ alpha_dummy_057 := by
    simpa [alpha_dummy_056, alpha_dummy_057] using
      (freshVar_injective (((Class.cv alpha_dummy_049)).fv) (i := 0) (j := 1) (by decide))
  have fresh_046 : alpha_dummy_060 ∉ (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) := by
    simpa [alpha_dummy_060] using freshVar_not_mem (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) 0
  have fresh_047 : alpha_dummy_061 ∉ (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) := by
    simpa [alpha_dummy_061] using freshVar_not_mem (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) 1
  have fresh_048 : alpha_dummy_062 ∉ (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) := by
    simpa [alpha_dummy_062] using freshVar_not_mem (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) 2
  have distinct_049 : alpha_dummy_060 ≠ alpha_dummy_061 := by
    simpa [alpha_dummy_060, alpha_dummy_061] using
      (freshVar_injective (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) (i := 0) (j := 1) (by decide))
  have distinct_050 : alpha_dummy_060 ≠ alpha_dummy_062 := by
    simpa [alpha_dummy_060, alpha_dummy_062] using
      (freshVar_injective (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) (i := 0) (j := 2) (by decide))
  have distinct_051 : alpha_dummy_061 ≠ alpha_dummy_062 := by
    simpa [alpha_dummy_061, alpha_dummy_062] using
      (freshVar_injective (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) (i := 1) (j := 2) (by decide))
  have fresh_052 : alpha_dummy_063 ∉ (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) := by
    simpa [alpha_dummy_063] using freshVar_not_mem (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) 0
  have fresh_053 : alpha_dummy_064 ∉ (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) := by
    simpa [alpha_dummy_064] using freshVar_not_mem (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) 1
  have fresh_054 : alpha_dummy_065 ∉ (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) := by
    simpa [alpha_dummy_065] using freshVar_not_mem (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) 2
  have distinct_055 : alpha_dummy_063 ≠ alpha_dummy_064 := by
    simpa [alpha_dummy_063, alpha_dummy_064] using
      (freshVar_injective (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) (i := 0) (j := 1) (by decide))
  have distinct_056 : alpha_dummy_063 ≠ alpha_dummy_065 := by
    simpa [alpha_dummy_063, alpha_dummy_065] using
      (freshVar_injective (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) (i := 0) (j := 2) (by decide))
  have distinct_057 : alpha_dummy_064 ≠ alpha_dummy_065 := by
    simpa [alpha_dummy_064, alpha_dummy_065] using
      (freshVar_injective (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) (i := 1) (j := 2) (by decide))
  have fresh_058 : alpha_dummy_072 ∉ (((Class.cv alpha_dummy_061)).fv ∪ ((Class.cv alpha_dummy_061)).fv) := by
    simpa [alpha_dummy_072] using freshVar_not_mem (((Class.cv alpha_dummy_061)).fv ∪ ((Class.cv alpha_dummy_061)).fv) 0
  have fresh_059 : alpha_dummy_068 ∉ (((Class.cv alpha_dummy_061)).fv ∪ ((Class.cv alpha_dummy_062)).fv) := by
    simpa [alpha_dummy_068] using freshVar_not_mem (((Class.cv alpha_dummy_061)).fv ∪ ((Class.cv alpha_dummy_062)).fv) 0
  have fresh_060 : alpha_dummy_074 ∉ (((Class.cv alpha_dummy_062)).fv ∪ ((Class.cv alpha_dummy_062)).fv) := by
    simpa [alpha_dummy_074] using freshVar_not_mem (((Class.cv alpha_dummy_062)).fv ∪ ((Class.cv alpha_dummy_062)).fv) 0
  have fresh_061 : alpha_dummy_073 ∉ (((Class.cv alpha_dummy_064)).fv ∪ ((Class.cv alpha_dummy_064)).fv) := by
    simpa [alpha_dummy_073] using freshVar_not_mem (((Class.cv alpha_dummy_064)).fv ∪ ((Class.cv alpha_dummy_064)).fv) 0
  have fresh_062 : alpha_dummy_069 ∉ (((Class.cv alpha_dummy_064)).fv ∪ ((Class.cv alpha_dummy_065)).fv) := by
    simpa [alpha_dummy_069] using freshVar_not_mem (((Class.cv alpha_dummy_064)).fv ∪ ((Class.cv alpha_dummy_065)).fv) 0
  have fresh_063 : alpha_dummy_075 ∉ (((Class.cv alpha_dummy_065)).fv ∪ ((Class.cv alpha_dummy_065)).fv) := by
    simpa [alpha_dummy_075] using freshVar_not_mem (((Class.cv alpha_dummy_065)).fv ∪ ((Class.cv alpha_dummy_065)).fv) 0
  have fresh_064 : alpha_dummy_045 ∉ (((Class.cv w)).fv) := by
    simpa [alpha_dummy_045] using freshVar_not_mem (((Class.cv w)).fv) 0
  have fresh_065 : alpha_dummy_008 ∉ (((Class.cv x)).fv ∪ ((Class.cv y)).fv) := by
    simpa [alpha_dummy_008] using freshVar_not_mem (((Class.cv x)).fv ∪ ((Class.cv y)).fv) 0
  have fresh_066 : alpha_dummy_009 ∉ (((Class.cv x)).fv ∪ ((Class.cv y)).fv) := by
    simpa [alpha_dummy_009] using freshVar_not_mem (((Class.cv x)).fv ∪ ((Class.cv y)).fv) 1
  have distinct_067 : alpha_dummy_008 ≠ alpha_dummy_009 := by
    simpa [alpha_dummy_008, alpha_dummy_009] using
      (freshVar_injective (((Class.cv x)).fv ∪ ((Class.cv y)).fv) (i := 0) (j := 1) (by decide))
  have fresh_068 : alpha_dummy_043 ∉ (((Class.cv z)).fv) := by
    simpa [alpha_dummy_043] using freshVar_not_mem (((Class.cv z)).fv) 0
  have fresh_069 : alpha_dummy_048 ∉ (((Class.cv z)).fv ∪ ((Class.cv w)).fv) := by
    simpa [alpha_dummy_048] using freshVar_not_mem (((Class.cv z)).fv ∪ ((Class.cv w)).fv) 0
  have fresh_070 : alpha_dummy_049 ∉ (((Class.cv z)).fv ∪ ((Class.cv w)).fv) := by
    simpa [alpha_dummy_049] using freshVar_not_mem (((Class.cv z)).fv ∪ ((Class.cv w)).fv) 1
  have distinct_071 : alpha_dummy_048 ≠ alpha_dummy_049 := by
    simpa [alpha_dummy_048, alpha_dummy_049] using
      (freshVar_injective (((Class.cv z)).fv ∪ ((Class.cv w)).fv) (i := 0) (j := 1) (by decide))
  have fresh_072 : alpha_dummy_018 ∉ (((Wff.classMem (Class.cv alpha_dummy_014) (syn_cnnc))).fv ∪ ((syn_cplc (Class.cv alpha_dummy_014) (syn_c1c))).fv ∪ ((Class.cv alpha_dummy_014)).fv) := by
  ...
  have fresh_073 : alpha_dummy_019 ∉ (((Wff.classMem (Class.cv alpha_dummy_016) (syn_cnnc))).fv ∪ ((syn_cplc (Class.cv alpha_dummy_016) (syn_c1c))).fv ∪ ((Class.cv alpha_dummy_016)).fv) := by
  ...
  have fresh_074 : alpha_dummy_058 ∉ (((Wff.classMem (Class.cv alpha_dummy_054) (syn_cnnc))).fv ∪ ((syn_cplc (Class.cv alpha_dummy_054) (syn_c1c))).fv ∪ ((Class.cv alpha_dummy_054)).fv) := by
    simpa [alpha_dummy_058] using freshVar_not_mem (((Wff.classMem (Class.cv alpha_dummy_054) (syn_cnnc))).fv ∪ ((syn_cplc (Class.cv alpha_dummy_054) (syn_c1c))).fv ∪ ((Class.cv alpha_dummy_054)).fv) 0
  have fresh_075 : alpha_dummy_059 ∉ (((Wff.classMem (Class.cv alpha_dummy_056) (syn_cnnc))).fv ∪ ((syn_cplc (Class.cv alpha_dummy_056) (syn_c1c))).fv ∪ ((Class.cv alpha_dummy_056)).fv) := by
    simpa [alpha_dummy_059] using freshVar_not_mem (((Wff.classMem (Class.cv alpha_dummy_056) (syn_cnnc))).fv ∪ ((syn_cplc (Class.cv alpha_dummy_056) (syn_c1c))).fv ∪ ((Class.cv alpha_dummy_056)).fv) 0
  have fresh_076 : alpha_dummy_010 ∉ (((syn_ccompl (Class.cab alpha_dummy_006 (syn_wrex alpha_dummy_007 (Class.cv alpha_dummy_001) (Wff.classEq (Class.cv alpha_dummy_006) (syn_cphi (Class.cv alpha_dummy_007))))))).fv ∪ ((syn_ccompl (Class.cab alpha_dummy_006 (syn_wrex alpha_dummy_007 (Class.cv alpha_dummy_002) (Wff.classEq (Class.cv alpha_dummy_006) (syn_cun (syn_cphi (Class.cv alpha_dummy_007)) (syn_csn (syn_c0c)))))))).fv) := by
    simpa [alpha_dummy_010] using freshVar_not_mem (((syn_ccompl (Class.cab alpha_dummy_006 (syn_wrex alpha_dummy_007 (Class.cv alpha_dummy_001) (Wff.classEq (Class.cv alpha_dummy_006) (syn_cphi (Class.cv alpha_dummy_007))))))).fv ∪ ((syn_ccompl (Class.cab alpha_dummy_006 (syn_wrex alpha_dummy_007 (Class.cv alpha_dummy_002) (Wff.classEq (Class.cv alpha_dummy_006) (syn_cun (syn_cphi (Class.cv alpha_dummy_007)) (syn_csn (syn_c0c)))))))).fv) 0
  have fresh_077 : alpha_dummy_011 ∉ (((syn_ccompl (Class.cab alpha_dummy_008 (syn_wrex alpha_dummy_009 (Class.cv x) (Wff.classEq (Class.cv alpha_dummy_008) (syn_cphi (Class.cv alpha_dummy_009))))))).fv ∪ ((syn_ccompl (Class.cab alpha_dummy_008 (syn_wrex alpha_dummy_009 (Class.cv y) (Wff.classEq (Class.cv alpha_dummy_008) (syn_cun (syn_cphi (Class.cv alpha_dummy_009)) (syn_csn (syn_c0c)))))))).fv) := by
    simpa [alpha_dummy_011] using freshVar_not_mem (((syn_ccompl (Class.cab alpha_dummy_008 (syn_wrex alpha_dummy_009 (Class.cv x) (Wff.classEq (Class.cv alpha_dummy_008) (syn_cphi (Class.cv alpha_dummy_009))))))).fv ∪ ((syn_ccompl (Class.cab alpha_dummy_008 (syn_wrex alpha_dummy_009 (Class.cv y) (Wff.classEq (Class.cv alpha_dummy_008) (syn_cun (syn_cphi (Class.cv alpha_dummy_009)) (syn_csn (syn_c0c)))))))).fv) 0
  have fresh_078 : alpha_dummy_050 ∉ (((syn_ccompl (Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_003) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cphi (Class.cv alpha_dummy_047))))))).fv ∪ ((syn_ccompl (Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_000) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cun (syn_cphi (Class.cv alpha_dummy_047)) (syn_csn (syn_c0c)))))))).fv) := by
    simpa [alpha_dummy_050] using freshVar_not_mem (((syn_ccompl (Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_003) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cphi (Class.cv alpha_dummy_047))))))).fv ∪ ((syn_ccompl (Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_000) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cun (syn_cphi (Class.cv alpha_dummy_047)) (syn_csn (syn_c0c)))))))).fv) 0
  have fresh_079 : alpha_dummy_051 ∉ (((syn_ccompl (Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv z) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cphi (Class.cv alpha_dummy_049))))))).fv ∪ ((syn_ccompl (Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv w) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cun (syn_cphi (Class.cv alpha_dummy_049)) (syn_csn (syn_c0c)))))))).fv) := by
    simpa [alpha_dummy_051] using freshVar_not_mem (((syn_ccompl (Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv z) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cphi (Class.cv alpha_dummy_049))))))).fv ∪ ((syn_ccompl (Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv w) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cun (syn_cphi (Class.cv alpha_dummy_049)) (syn_csn (syn_c0c)))))))).fv) 0
  have fresh_080 : alpha_dummy_030 ∉ (((syn_ccompl (Class.cv alpha_dummy_021))).fv ∪ ((syn_ccompl (Class.cv alpha_dummy_022))).fv) := by
  ...
  have fresh_081 : alpha_dummy_031 ∉ (((syn_ccompl (Class.cv alpha_dummy_024))).fv ∪ ((syn_ccompl (Class.cv alpha_dummy_025))).fv) := by
  ...
  have fresh_082 : alpha_dummy_070 ∉ (((syn_ccompl (Class.cv alpha_dummy_061))).fv ∪ ((syn_ccompl (Class.cv alpha_dummy_062))).fv) := by
    simpa [alpha_dummy_070] using freshVar_not_mem (((syn_ccompl (Class.cv alpha_dummy_061))).fv ∪ ((syn_ccompl (Class.cv alpha_dummy_062))).fv) 0
  have fresh_083 : alpha_dummy_071 ∉ (((syn_ccompl (Class.cv alpha_dummy_064))).fv ∪ ((syn_ccompl (Class.cv alpha_dummy_065))).fv) := by
    simpa [alpha_dummy_071] using freshVar_not_mem (((syn_ccompl (Class.cv alpha_dummy_064))).fv ∪ ((syn_ccompl (Class.cv alpha_dummy_065))).fv) 0
  have fresh_084 : alpha_dummy_038 ∉ (((syn_ccompl (syn_cphi (Class.cv alpha_dummy_007)))).fv ∪ ((syn_ccompl (syn_csn (syn_c0c)))).fv) := by
  ...
  have fresh_085 : alpha_dummy_039 ∉ (((syn_ccompl (syn_cphi (Class.cv alpha_dummy_009)))).fv ∪ ((syn_ccompl (syn_csn (syn_c0c)))).fv) := by
  ...
  have fresh_086 : alpha_dummy_078 ∉ (((syn_ccompl (syn_cphi (Class.cv alpha_dummy_047)))).fv ∪ ((syn_ccompl (syn_csn (syn_c0c)))).fv) := by
    simpa [alpha_dummy_078] using freshVar_not_mem (((syn_ccompl (syn_cphi (Class.cv alpha_dummy_047)))).fv ∪ ((syn_ccompl (syn_csn (syn_c0c)))).fv) 0
  have fresh_087 : alpha_dummy_079 ∉ (((syn_ccompl (syn_cphi (Class.cv alpha_dummy_049)))).fv ∪ ((syn_ccompl (syn_csn (syn_c0c)))).fv) := by
    simpa [alpha_dummy_079] using freshVar_not_mem (((syn_ccompl (syn_cphi (Class.cv alpha_dummy_049)))).fv ∪ ((syn_ccompl (syn_csn (syn_c0c)))).fv) 0
  have fresh_088 : alpha_dummy_026 ∉ (((syn_cnin (Class.cv alpha_dummy_021) (Class.cv alpha_dummy_022))).fv ∪ ((syn_cnin (Class.cv alpha_dummy_021) (Class.cv alpha_dummy_022))).fv) := by
  ...
  have fresh_089 : alpha_dummy_027 ∉ (((syn_cnin (Class.cv alpha_dummy_024) (Class.cv alpha_dummy_025))).fv ∪ ((syn_cnin (Class.cv alpha_dummy_024) (Class.cv alpha_dummy_025))).fv) := by
  ...
  have fresh_090 : alpha_dummy_066 ∉ (((syn_cnin (Class.cv alpha_dummy_061) (Class.cv alpha_dummy_062))).fv ∪ ((syn_cnin (Class.cv alpha_dummy_061) (Class.cv alpha_dummy_062))).fv) := by
    simpa [alpha_dummy_066] using freshVar_not_mem (((syn_cnin (Class.cv alpha_dummy_061) (Class.cv alpha_dummy_062))).fv ∪ ((syn_cnin (Class.cv alpha_dummy_061) (Class.cv alpha_dummy_062))).fv) 0
  have fresh_091 : alpha_dummy_067 ∉ (((syn_cnin (Class.cv alpha_dummy_064) (Class.cv alpha_dummy_065))).fv ∪ ((syn_cnin (Class.cv alpha_dummy_064) (Class.cv alpha_dummy_065))).fv) := by
    simpa [alpha_dummy_067] using freshVar_not_mem (((syn_cnin (Class.cv alpha_dummy_064) (Class.cv alpha_dummy_065))).fv ∪ ((syn_cnin (Class.cv alpha_dummy_064) (Class.cv alpha_dummy_065))).fv) 0
  have fresh_092 : alpha_dummy_040 ∉ (((syn_cphi (Class.cv alpha_dummy_007))).fv ∪ ((syn_cphi (Class.cv alpha_dummy_007))).fv) := by
    simpa [alpha_dummy_040] using freshVar_not_mem (((syn_cphi (Class.cv alpha_dummy_007))).fv ∪ ((syn_cphi (Class.cv alpha_dummy_007))).fv) 0
  have fresh_093 : alpha_dummy_041 ∉ (((syn_cphi (Class.cv alpha_dummy_009))).fv ∪ ((syn_cphi (Class.cv alpha_dummy_009))).fv) := by
    simpa [alpha_dummy_041] using freshVar_not_mem (((syn_cphi (Class.cv alpha_dummy_009))).fv ∪ ((syn_cphi (Class.cv alpha_dummy_009))).fv) 0
  have fresh_094 : alpha_dummy_080 ∉ (((syn_cphi (Class.cv alpha_dummy_047))).fv ∪ ((syn_cphi (Class.cv alpha_dummy_047))).fv) := by
    simpa [alpha_dummy_080] using freshVar_not_mem (((syn_cphi (Class.cv alpha_dummy_047))).fv ∪ ((syn_cphi (Class.cv alpha_dummy_047))).fv) 0
  have fresh_095 : alpha_dummy_081 ∉ (((syn_cphi (Class.cv alpha_dummy_049))).fv ∪ ((syn_cphi (Class.cv alpha_dummy_049))).fv) := by
    simpa [alpha_dummy_081] using freshVar_not_mem (((syn_cphi (Class.cv alpha_dummy_049))).fv ∪ ((syn_cphi (Class.cv alpha_dummy_049))).fv) 0
  have fresh_096 : alpha_dummy_000 ∉ ((A).fv) := by
    simpa [alpha_dummy_000] using freshVar_not_mem ((A).fv) 0
  have fresh_097 : alpha_dummy_001 ∉ ((A).fv) := by
    simpa [alpha_dummy_001] using freshVar_not_mem ((A).fv) 1
  have fresh_098 : alpha_dummy_002 ∉ ((A).fv) := by
    simpa [alpha_dummy_002] using freshVar_not_mem ((A).fv) 2
  have fresh_099 : alpha_dummy_003 ∉ ((A).fv) := by
    simpa [alpha_dummy_003] using freshVar_not_mem ((A).fv) 3
  have distinct_100 : alpha_dummy_000 ≠ alpha_dummy_001 := by
    simpa [alpha_dummy_000, alpha_dummy_001] using
      (freshVar_injective ((A).fv) (i := 0) (j := 1) (by decide))
  have distinct_101 : alpha_dummy_000 ≠ alpha_dummy_002 := by
    simpa [alpha_dummy_000, alpha_dummy_002] using
      (freshVar_injective ((A).fv) (i := 0) (j := 2) (by decide))
  have distinct_102 : alpha_dummy_000 ≠ alpha_dummy_003 := by
    simpa [alpha_dummy_000, alpha_dummy_003] using
      (freshVar_injective ((A).fv) (i := 0) (j := 3) (by decide))
  have distinct_103 : alpha_dummy_001 ≠ alpha_dummy_002 := by
    simpa [alpha_dummy_001, alpha_dummy_002] using
      (freshVar_injective ((A).fv) (i := 1) (j := 2) (by decide))
  have distinct_104 : alpha_dummy_001 ≠ alpha_dummy_003 := by
    simpa [alpha_dummy_001, alpha_dummy_003] using
      (freshVar_injective ((A).fv) (i := 1) (j := 3) (by decide))
  have distinct_105 : alpha_dummy_002 ≠ alpha_dummy_003 := by
    simpa [alpha_dummy_002, alpha_dummy_003] using
      (freshVar_injective ((A).fv) (i := 2) (j := 3) (by decide))
  have fresh_106 : alpha_dummy_004 ∉ (({alpha_dummy_001} : Finset Var) ∪ ({alpha_dummy_002} : Finset Var) ∪ ((syn_wex alpha_dummy_003 (syn_wex alpha_dummy_000 (syn_w3a (Wff.classEq (Class.cv alpha_dummy_001) (syn_csn (Class.cv alpha_dummy_003))) (Wff.classEq (Class.cv alpha_dummy_002) (syn_csn (Class.cv alpha_dummy_000))) (syn_wbr (Class.cv alpha_dummy_003) A (Class.cv alpha_dummy_000)))))).fv) := by
    simpa [alpha_dummy_004] using freshVar_not_mem (({alpha_dummy_001} : Finset Var) ∪ ({alpha_dummy_002} : Finset Var) ∪ ((syn_wex alpha_dummy_003 (syn_wex alpha_dummy_000 (syn_w3a (Wff.classEq (Class.cv alpha_dummy_001) (syn_csn (Class.cv alpha_dummy_003))) (Wff.classEq (Class.cv alpha_dummy_002) (syn_csn (Class.cv alpha_dummy_000))) (syn_wbr (Class.cv alpha_dummy_003) A (Class.cv alpha_dummy_000)))))).fv) 0
  have fresh_107 : alpha_dummy_005 ∉ (({x} : Finset Var) ∪ ({y} : Finset Var) ∪ ((syn_wex z (syn_wex w (syn_w3a (Wff.classEq (Class.cv x) (syn_csn (Class.cv z))) (Wff.classEq (Class.cv y) (syn_csn (Class.cv w))) (syn_wbr (Class.cv z) A (Class.cv w)))))).fv) := by
    simpa [alpha_dummy_005] using freshVar_not_mem (({x} : Finset Var) ∪ ({y} : Finset Var) ∪ ((syn_wex z (syn_wex w (syn_w3a (Wff.classEq (Class.cv x) (syn_csn (Class.cv z))) (Wff.classEq (Class.cv y) (syn_csn (Class.cv w))) (syn_wbr (Class.cv z) A (Class.cv w)))))).fv) 0
  have support_mem_0000 : alpha_dummy_001 ∈ (({alpha_dummy_001} : Finset Var) ∪ ({alpha_dummy_002} : Finset Var) ∪ ((syn_wex alpha_dummy_003 (syn_wex alpha_dummy_000 (syn_w3a (Wff.classEq (Class.cv alpha_dummy_001) (syn_csn (Class.cv alpha_dummy_003))) (Wff.classEq (Class.cv alpha_dummy_002) (syn_csn (Class.cv alpha_dummy_000))) (syn_wbr (Class.cv alpha_dummy_003) A (Class.cv alpha_dummy_000)))))).fv) := by
    apply Finset.mem_union_left
    apply Finset.mem_union_left
    exact Finset.mem_singleton_self _
  have support_mem_0001 : x ∈ (({x} : Finset Var) ∪ ({y} : Finset Var) ∪ ((syn_wex z (syn_wex w (syn_w3a (Wff.classEq (Class.cv x) (syn_csn (Class.cv z))) (Wff.classEq (Class.cv y) (syn_csn (Class.cv w))) (syn_wbr (Class.cv z) A (Class.cv w)))))).fv) := by
    apply Finset.mem_union_left
    apply Finset.mem_union_left
    exact Finset.mem_singleton_self _
  have support_mem_0002 : alpha_dummy_002 ∈ (({alpha_dummy_001} : Finset Var) ∪ ({alpha_dummy_002} : Finset Var) ∪ ((syn_wex alpha_dummy_003 (syn_wex alpha_dummy_000 (syn_w3a (Wff.classEq (Class.cv alpha_dummy_001) (syn_csn (Class.cv alpha_dummy_003))) (Wff.classEq (Class.cv alpha_dummy_002) (syn_csn (Class.cv alpha_dummy_000))) (syn_wbr (Class.cv alpha_dummy_003) A (Class.cv alpha_dummy_000)))))).fv) := by
    ...
    exact Finset.mem_singleton_self _
  have support_mem_0003 : y ∈ (({x} : Finset Var) ∪ ({y} : Finset Var) ∪ ((syn_wex z (syn_wex w (syn_w3a (Wff.classEq (Class.cv x) (syn_csn (Class.cv z))) (Wff.classEq (Class.cv y) (syn_csn (Class.cv w))) (syn_wbr (Class.cv z) A (Class.cv w)))))).fv) := by
    apply Finset.mem_union_left
    apply Finset.mem_union_right
    exact Finset.mem_singleton_self _
  ...
  have support_mem_0041 : alpha_dummy_009 ∈ (((syn_cphi (Class.cv alpha_dummy_009))).fv ∪ ((syn_cphi (Class.cv alpha_dummy_009))).fv) := by
    ...
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0042 : alpha_dummy_003 ∈ (((Class.cv alpha_dummy_003)).fv) := by
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0043 : z ∈ (((Class.cv z)).fv) := by
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0044 : alpha_dummy_000 ∈ (((Class.cv alpha_dummy_000)).fv) := by
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0045 : w ∈ (((Class.cv w)).fv) := by
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0046 : alpha_dummy_003 ∈ (((Class.cv alpha_dummy_003)).fv ∪ ((Class.cv alpha_dummy_000)).fv) := by
    apply Finset.mem_union_left
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0047 : alpha_dummy_003 ∈ (((syn_ccompl (Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_003) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cphi (Class.cv alpha_dummy_047))))))).fv ∪ ((syn_ccompl (Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_000) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cun (syn_cphi (Class.cv alpha_dummy_047)) (syn_csn (syn_c0c)))))))).fv) := by
    apply Finset.mem_union_left
    rw [fv_syn_ccompl]
    rw [fv_class_cab]
    apply Finset.mem_erase.mpr
    constructor
    · exact (Nat.ne_of_lt (mem_lt_freshVar support_mem_0046 0))
    ·
      rw [fv_syn_wrex]
      apply Finset.mem_union_left
      apply Finset.mem_erase.mpr
      constructor
      · exact (Nat.ne_of_lt (mem_lt_freshVar support_mem_0046 1))
      ·
        rw [fv_class_cv]
        exact Finset.mem_singleton_self _
  have support_mem_0048 : z ∈ (((Class.cv z)).fv ∪ ((Class.cv w)).fv) := by
    apply Finset.mem_union_left
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0049 : z ∈ (((syn_ccompl (Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv z) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cphi (Class.cv alpha_dummy_049))))))).fv ∪ ((syn_ccompl (Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv w) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cun (syn_cphi (Class.cv alpha_dummy_049)) (syn_csn (syn_c0c)))))))).fv) := by
    apply Finset.mem_union_left
    rw [fv_syn_ccompl]
    rw [fv_class_cab]
    apply Finset.mem_erase.mpr
    constructor
    · exact (Nat.ne_of_lt (mem_lt_freshVar support_mem_0048 0))
    ·
      rw [fv_syn_wrex]
      apply Finset.mem_union_left
      apply Finset.mem_erase.mpr
      constructor
      · exact (Nat.ne_of_lt (mem_lt_freshVar support_mem_0048 1))
      ·
        rw [fv_class_cv]
        exact Finset.mem_singleton_self _
  have support_mem_0050 : alpha_dummy_003 ∈ (((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_003) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cphi (Class.cv alpha_dummy_047)))))).fv ∪ ((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_003) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cphi (Class.cv alpha_dummy_047)))))).fv) := by
    apply Finset.mem_union_left
    rw [fv_class_cab]
    apply Finset.mem_erase.mpr
    constructor
    ...
    ·
      ...
      ·
        rw [fv_class_cv]
        exact Finset.mem_singleton_self _
  have support_mem_0051 : z ∈ (((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv z) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cphi (Class.cv alpha_dummy_049)))))).fv ∪ ((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv z) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cphi (Class.cv alpha_dummy_049)))))).fv) := by
    apply Finset.mem_union_left
    rw [fv_class_cab]
    apply Finset.mem_erase.mpr
    constructor
    ...
    ·
      ...
      ·
        rw [fv_class_cv]
        exact Finset.mem_singleton_self _
  have support_mem_0052 : alpha_dummy_047 ∈ (((Class.cv alpha_dummy_047)).fv) := by
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0053 : alpha_dummy_049 ∈ (((Class.cv alpha_dummy_049)).fv) := by
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0054 : alpha_dummy_054 ∈ (((Wff.classMem (Class.cv alpha_dummy_054) (syn_cnnc))).fv ∪ ((syn_cplc (Class.cv alpha_dummy_054) (syn_c1c))).fv ∪ ((Class.cv alpha_dummy_054)).fv) := by
    apply Finset.mem_union_left
    apply Finset.mem_union_left
    rw [fv_wff_classMem]
    apply Finset.mem_union_left
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0055 : alpha_dummy_056 ∈ (((Wff.classMem (Class.cv alpha_dummy_056) (syn_cnnc))).fv ∪ ((syn_cplc (Class.cv alpha_dummy_056) (syn_c1c))).fv ∪ ((Class.cv alpha_dummy_056)).fv) := by
    apply Finset.mem_union_left
    apply Finset.mem_union_left
    rw [fv_wff_classMem]
    apply Finset.mem_union_left
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0056 : alpha_dummy_054 ∈ (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) := by
    apply Finset.mem_union_left
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0057 : alpha_dummy_056 ∈ (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) := by
    apply Finset.mem_union_left
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0058 : alpha_dummy_061 ∈ (((syn_cnin (Class.cv alpha_dummy_061) (Class.cv alpha_dummy_062))).fv ∪ ((syn_cnin (Class.cv alpha_dummy_061) (Class.cv alpha_dummy_062))).fv) := by
    apply Finset.mem_union_left
    rw [fv_syn_cnin]
    apply Finset.mem_union_left
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0059 : alpha_dummy_064 ∈ (((syn_cnin (Class.cv alpha_dummy_064) (Class.cv alpha_dummy_065))).fv ∪ ((syn_cnin (Class.cv alpha_dummy_064) (Class.cv alpha_dummy_065))).fv) := by
    apply Finset.mem_union_left
    rw [fv_syn_cnin]
    apply Finset.mem_union_left
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0060 : alpha_dummy_061 ∈ (((Class.cv alpha_dummy_061)).fv ∪ ((Class.cv alpha_dummy_062)).fv) := by
    apply Finset.mem_union_left
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0061 : alpha_dummy_064 ∈ (((Class.cv alpha_dummy_064)).fv ∪ ((Class.cv alpha_dummy_065)).fv) := by
    apply Finset.mem_union_left
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0062 : alpha_dummy_062 ∈ (((syn_cnin (Class.cv alpha_dummy_061) (Class.cv alpha_dummy_062))).fv ∪ ((syn_cnin (Class.cv alpha_dummy_061) (Class.cv alpha_dummy_062))).fv) := by
    apply Finset.mem_union_left
    rw [fv_syn_cnin]
    apply Finset.mem_union_right
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0063 : alpha_dummy_065 ∈ (((syn_cnin (Class.cv alpha_dummy_064) (Class.cv alpha_dummy_065))).fv ∪ ((syn_cnin (Class.cv alpha_dummy_064) (Class.cv alpha_dummy_065))).fv) := by
    apply Finset.mem_union_left
    rw [fv_syn_cnin]
    apply Finset.mem_union_right
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0064 : alpha_dummy_062 ∈ (((Class.cv alpha_dummy_061)).fv ∪ ((Class.cv alpha_dummy_062)).fv) := by
    apply Finset.mem_union_right
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0065 : alpha_dummy_065 ∈ (((Class.cv alpha_dummy_064)).fv ∪ ((Class.cv alpha_dummy_065)).fv) := by
    apply Finset.mem_union_right
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0066 : alpha_dummy_061 ∈ (((syn_ccompl (Class.cv alpha_dummy_061))).fv ∪ ((syn_ccompl (Class.cv alpha_dummy_062))).fv) := by
    apply Finset.mem_union_left
    rw [fv_syn_ccompl]
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0067 : alpha_dummy_064 ∈ (((syn_ccompl (Class.cv alpha_dummy_064))).fv ∪ ((syn_ccompl (Class.cv alpha_dummy_065))).fv) := by
    apply Finset.mem_union_left
    rw [fv_syn_ccompl]
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0068 : alpha_dummy_061 ∈ (((Class.cv alpha_dummy_061)).fv ∪ ((Class.cv alpha_dummy_061)).fv) := by
    apply Finset.mem_union_left
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0069 : alpha_dummy_064 ∈ (((Class.cv alpha_dummy_064)).fv ∪ ((Class.cv alpha_dummy_064)).fv) := by
    apply Finset.mem_union_left
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0070 : alpha_dummy_062 ∈ (((syn_ccompl (Class.cv alpha_dummy_061))).fv ∪ ((syn_ccompl (Class.cv alpha_dummy_062))).fv) := by
    apply Finset.mem_union_right
    rw [fv_syn_ccompl]
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0071 : alpha_dummy_065 ∈ (((syn_ccompl (Class.cv alpha_dummy_064))).fv ∪ ((syn_ccompl (Class.cv alpha_dummy_065))).fv) := by
    apply Finset.mem_union_right
    rw [fv_syn_ccompl]
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0072 : alpha_dummy_062 ∈ (((Class.cv alpha_dummy_062)).fv ∪ ((Class.cv alpha_dummy_062)).fv) := by
    apply Finset.mem_union_left
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0073 : alpha_dummy_065 ∈ (((Class.cv alpha_dummy_065)).fv ∪ ((Class.cv alpha_dummy_065)).fv) := by
    apply Finset.mem_union_left
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0074 : alpha_dummy_000 ∈ (((Class.cv alpha_dummy_003)).fv ∪ ((Class.cv alpha_dummy_000)).fv) := by
    apply Finset.mem_union_right
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0075 : alpha_dummy_000 ∈ (((syn_ccompl (Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_003) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cphi (Class.cv alpha_dummy_047))))))).fv ∪ ((syn_ccompl (Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_000) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cun (syn_cphi (Class.cv alpha_dummy_047)) (syn_csn (syn_c0c)))))))).fv) := by
    apply Finset.mem_union_right
    rw [fv_syn_ccompl]
    rw [fv_class_cab]
    apply Finset.mem_erase.mpr
    constructor
    · exact (Nat.ne_of_lt (mem_lt_freshVar support_mem_0074 0))
    ·
      rw [fv_syn_wrex]
      apply Finset.mem_union_left
      apply Finset.mem_erase.mpr
      constructor
      · exact (Nat.ne_of_lt (mem_lt_freshVar support_mem_0074 1))
      ·
        rw [fv_class_cv]
        exact Finset.mem_singleton_self _
  have support_mem_0076 : w ∈ (((Class.cv z)).fv ∪ ((Class.cv w)).fv) := by
    apply Finset.mem_union_right
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0077 : w ∈ (((syn_ccompl (Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv z) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cphi (Class.cv alpha_dummy_049))))))).fv ∪ ((syn_ccompl (Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv w) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cun (syn_cphi (Class.cv alpha_dummy_049)) (syn_csn (syn_c0c)))))))).fv) := by
    apply Finset.mem_union_right
    rw [fv_syn_ccompl]
    rw [fv_class_cab]
    apply Finset.mem_erase.mpr
    constructor
    · exact (Nat.ne_of_lt (mem_lt_freshVar support_mem_0076 0))
    ·
      rw [fv_syn_wrex]
      apply Finset.mem_union_left
      apply Finset.mem_erase.mpr
      constructor
      · exact (Nat.ne_of_lt (mem_lt_freshVar support_mem_0076 1))
      ·
        rw [fv_class_cv]
        exact Finset.mem_singleton_self _
  have support_mem_0078 : alpha_dummy_000 ∈ (((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_000) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cun (syn_cphi (Class.cv alpha_dummy_047)) (syn_csn (syn_c0c))))))).fv ∪ ((Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_000) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cun (syn_cphi (Class.cv alpha_dummy_047)) (syn_csn (syn_c0c))))))).fv) := by
    apply Finset.mem_union_left
    rw [fv_class_cab]
    apply Finset.mem_erase.mpr
    constructor
    ...
    ·
      ...
      ·
        rw [fv_class_cv]
        exact Finset.mem_singleton_self _
  have support_mem_0079 : w ∈ (((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv w) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cun (syn_cphi (Class.cv alpha_dummy_049)) (syn_csn (syn_c0c))))))).fv ∪ ((Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv w) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cun (syn_cphi (Class.cv alpha_dummy_049)) (syn_csn (syn_c0c))))))).fv) := by
    apply Finset.mem_union_left
    rw [fv_class_cab]
    apply Finset.mem_erase.mpr
    constructor
    ...
    ·
      ...
      ·
        rw [fv_class_cv]
        exact Finset.mem_singleton_self _
  have support_mem_0080 : alpha_dummy_047 ∈ (((syn_ccompl (syn_cphi (Class.cv alpha_dummy_047)))).fv ∪ ((syn_ccompl (syn_csn (syn_c0c)))).fv) := by
    apply Finset.mem_union_left
    rw [fv_syn_ccompl]
    rw [fv_syn_cphi]
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0081 : alpha_dummy_049 ∈ (((syn_ccompl (syn_cphi (Class.cv alpha_dummy_049)))).fv ∪ ((syn_ccompl (syn_csn (syn_c0c)))).fv) := by
    apply Finset.mem_union_left
    rw [fv_syn_ccompl]
    rw [fv_syn_cphi]
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0082 : alpha_dummy_047 ∈ (((syn_cphi (Class.cv alpha_dummy_047))).fv ∪ ((syn_cphi (Class.cv alpha_dummy_047))).fv) := by
    apply Finset.mem_union_left
    rw [fv_syn_cphi]
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  have support_mem_0083 : alpha_dummy_049 ∈ (((syn_cphi (Class.cv alpha_dummy_049))).fv ∪ ((syn_cphi (Class.cv alpha_dummy_049))).fv) := by
    apply Finset.mem_union_left
    rw [fv_syn_cphi]
    rw [fv_class_cv]
    exact Finset.mem_singleton_self _
  ...
  have wpp_notmem_0109 : w ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0110 : alpha_dummy_050 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0111 : alpha_dummy_051 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0112 : alpha_dummy_052 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0113 : alpha_dummy_053 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0114 : alpha_dummy_046 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0115 : alpha_dummy_048 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0116 : alpha_dummy_047 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0117 : alpha_dummy_049 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0118 : alpha_dummy_055 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0119 : alpha_dummy_057 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0120 : alpha_dummy_054 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0121 : alpha_dummy_056 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0122 : alpha_dummy_058 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0123 : alpha_dummy_059 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0124 : alpha_dummy_060 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0125 : alpha_dummy_063 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0126 : alpha_dummy_061 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0127 : alpha_dummy_064 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0128 : alpha_dummy_062 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0129 : alpha_dummy_065 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_refl_0007 : TReflOn [(alpha_dummy_062, alpha_dummy_065), (alpha_dummy_061, alpha_dummy_064), (alpha_dummy_060, alpha_dummy_063), (alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_052, alpha_dummy_053), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] ((syn_c1c)).fv := by
    intro u hu
  ...
  have wpp_notmem_0133 : w ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0134 : alpha_dummy_050 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0135 : alpha_dummy_051 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0136 : alpha_dummy_052 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0137 : alpha_dummy_053 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0138 : alpha_dummy_046 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0139 : alpha_dummy_048 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0140 : alpha_dummy_047 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0141 : alpha_dummy_049 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0142 : alpha_dummy_055 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0143 : alpha_dummy_057 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0144 : alpha_dummy_054 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0145 : alpha_dummy_056 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0146 : alpha_dummy_058 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0147 : alpha_dummy_059 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0148 : alpha_dummy_060 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0149 : alpha_dummy_063 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0150 : alpha_dummy_061 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0151 : alpha_dummy_064 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0152 : alpha_dummy_062 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0153 : alpha_dummy_065 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_refl_0008 : TReflOn [(alpha_dummy_062, alpha_dummy_065), (alpha_dummy_061, alpha_dummy_064), (alpha_dummy_060, alpha_dummy_063), (alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_052, alpha_dummy_053), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] ((syn_c0)).fv := by
    intro u hu
  ...
  have split_alpha_0005 : TAlphaWff [(alpha_dummy_062, alpha_dummy_065), (alpha_dummy_061, alpha_dummy_064), (alpha_dummy_060, alpha_dummy_063), (alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_052, alpha_dummy_053), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (Wff.imp (Wff.classEq (syn_cin (Class.cv alpha_dummy_061) (Class.cv alpha_dummy_062)) (syn_c0)) (Wff.neg (Wff.classEq (Class.cv alpha_dummy_060) (syn_cun (Class.cv alpha_dummy_061) (Class.cv alpha_dummy_062))))) (Wff.imp (Wff.classEq (syn_cin (Class.cv alpha_dummy_064) (Class.cv alpha_dummy_065)) (syn_c0)) (Wff.neg (Wff.classEq (Class.cv alpha_dummy_063) (syn_cun (Class.cv alpha_dummy_064) (Class.cv alpha_dummy_065))))) :=
    (TAlphaWff.imp (TAlphaWff.classEq (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0060 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0061 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0058 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0059 0)) (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) (by decide)) (freshVar_injective (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) (by decide)) (TAlphaVar.here _ _ _)))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0064 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0065 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0062 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0063 0)) (TAlphaVar.here _ _ _))))))))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0060 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0061 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0058 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0059 0)) (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) (by decide)) (freshVar_injective (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) (by decide)) (TAlphaVar.here _ _ _)))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0064 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0065 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0062 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0063 0)) (TAlphaVar.here _ _ _)))))))))))))))) (TAlphaClass.refl_of_reflOn [(alpha_dummy_062, alpha_dummy_065), (alpha_dummy_061, alpha_dummy_064), (alpha_dummy_060, alpha_dummy_063), (alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_052, alpha_dummy_053), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (syn_c0) wpp_refl_0008)) (TAlphaWff.neg (TAlphaWff.classEq (TAlphaClass.cv (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) (by decide)) (freshVar_injective (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) (by decide)) (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) (by decide)) (freshVar_injective (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) (by decide)) (TAlphaVar.here _ _ _)))) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0068 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0069 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0066 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0067 0)) (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) (by decide)) (freshVar_injective (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) (by decide)) (TAlphaVar.here _ _ _)))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0068 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0069 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0066 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0067 0)) (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) (by decide)) (freshVar_injective (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) (by decide)) (TAlphaVar.here _ _ _)))))))))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0072 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0073 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0070 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0071 0)) (TAlphaVar.here _ _ _))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0072 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0073 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0070 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0071 0)) (TAlphaVar.here _ _ _)))))))))))))))))))
  ...
  have wpp_notmem_0157 : w ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0158 : alpha_dummy_050 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0159 : alpha_dummy_051 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0160 : alpha_dummy_052 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0161 : alpha_dummy_053 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0162 : alpha_dummy_046 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0163 : alpha_dummy_048 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0164 : alpha_dummy_047 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0165 : alpha_dummy_049 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0166 : alpha_dummy_055 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0167 : alpha_dummy_057 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0168 : alpha_dummy_054 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0169 : alpha_dummy_056 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0170 : alpha_dummy_058 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0171 : alpha_dummy_059 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_refl_0009 : TReflOn [(alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_052, alpha_dummy_053), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] ((syn_cnnc)).fv := by
    intro u hu
  ...
  have split_alpha_0006 : TAlphaWff [(alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_052, alpha_dummy_053), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (Wff.imp (Wff.classMem (Class.cv alpha_dummy_047) (Class.cv alpha_dummy_003)) (Wff.neg (Wff.classEq (Class.cv alpha_dummy_046) (syn_cphi (Class.cv alpha_dummy_047))))) (Wff.imp (Wff.classMem (Class.cv alpha_dummy_049) (Class.cv z)) (Wff.neg (Wff.classEq (Class.cv alpha_dummy_048) (syn_cphi (Class.cv alpha_dummy_049))))) :=
    (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0046 1)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0048 1)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0046 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0048 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0050 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0051 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0047 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0049 0)) (TAlphaVar.there (freshVar_injective ((A).fv) (by decide)) (Ne.symm dv_w_z) (TAlphaVar.here _ _ _)))))))) (TAlphaWff.neg (TAlphaWff.classEq (TAlphaClass.cv (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_003)).fv ∪ ((Class.cv alpha_dummy_000)).fv) (by decide)) (freshVar_injective (((Class.cv z)).fv ∪ ((Class.cv w)).fv) (by decide)) (TAlphaVar.here _ _ _))) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0052 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0053 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0052 1)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0053 1)) (TAlphaVar.here _ _ _))))) (TAlphaWff.neg (TAlphaWff.classEq (TAlphaClass.cv (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_047)).fv) (by decide)) (freshVar_injective (((Class.cv alpha_dummy_049)).fv) (by decide)) (TAlphaVar.here _ _ _))) (TAlphaClass.cab (TAlphaWff.imp (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0056 1)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0057 1)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0056 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0057 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0054 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0055 0)) (TAlphaVar.here _ _ _)))))) (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.refl_of_reflOn [(alpha_dummy_062, alpha_dummy_065), (alpha_dummy_061, alpha_dummy_064), (alpha_dummy_060, alpha_dummy_063), (alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_052, alpha_dummy_053), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (syn_c1c) wpp_refl_0007)) (TAlphaWff.neg (TAlphaWff.neg split_alpha_0005))))))))))))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0054 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0055 0)) (TAlphaVar.here _ _ _))) (TAlphaClass.refl_of_reflOn [(alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_052, alpha_dummy_053), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (syn_cnnc) wpp_refl_0009)))))) (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0054 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0055 0)) (TAlphaVar.here _ _ _)))) (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0054 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0055 0)) (TAlphaVar.here _ _ _))) (TAlphaClass.refl_of_reflOn [(alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_052, alpha_dummy_053), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (syn_cnnc) wpp_refl_0009)))))))))))))))))))
  have wpp_notmem_0172 : alpha_dummy_076 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0173 : alpha_dummy_077 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0174 : alpha_dummy_078 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0175 : alpha_dummy_079 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0176 : alpha_dummy_080 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_notmem_0177 : alpha_dummy_081 ∉ ((syn_c1c)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c1c) ▸ h_mem))
  have wpp_refl_0010 : TReflOn [(alpha_dummy_062, alpha_dummy_065), (alpha_dummy_061, alpha_dummy_064), (alpha_dummy_060, alpha_dummy_063), (alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_080, alpha_dummy_081), (alpha_dummy_078, alpha_dummy_079), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_076, alpha_dummy_077), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] ((syn_c1c)).fv := by
    intro u hu
  ...
  have wpp_notmem_0178 : alpha_dummy_076 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0179 : alpha_dummy_077 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0180 : alpha_dummy_078 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0181 : alpha_dummy_079 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0182 : alpha_dummy_080 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_notmem_0183 : alpha_dummy_081 ∉ ((syn_c0)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0) ▸ h_mem))
  have wpp_refl_0011 : TReflOn [(alpha_dummy_062, alpha_dummy_065), (alpha_dummy_061, alpha_dummy_064), (alpha_dummy_060, alpha_dummy_063), (alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_080, alpha_dummy_081), (alpha_dummy_078, alpha_dummy_079), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_076, alpha_dummy_077), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] ((syn_c0)).fv := by
    intro u hu
  ...
  have split_alpha_0007 : TAlphaWff [(alpha_dummy_062, alpha_dummy_065), (alpha_dummy_061, alpha_dummy_064), (alpha_dummy_060, alpha_dummy_063), (alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_080, alpha_dummy_081), (alpha_dummy_078, alpha_dummy_079), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_076, alpha_dummy_077), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (Wff.imp (Wff.classEq (syn_cin (Class.cv alpha_dummy_061) (Class.cv alpha_dummy_062)) (syn_c0)) (Wff.neg (Wff.classEq (Class.cv alpha_dummy_060) (syn_cun (Class.cv alpha_dummy_061) (Class.cv alpha_dummy_062))))) (Wff.imp (Wff.classEq (syn_cin (Class.cv alpha_dummy_064) (Class.cv alpha_dummy_065)) (syn_c0)) (Wff.neg (Wff.classEq (Class.cv alpha_dummy_063) (syn_cun (Class.cv alpha_dummy_064) (Class.cv alpha_dummy_065))))) :=
    (TAlphaWff.imp (TAlphaWff.classEq (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0060 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0061 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0058 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0059 0)) (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) (by decide)) (freshVar_injective (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) (by decide)) (TAlphaVar.here _ _ _)))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0064 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0065 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0062 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0063 0)) (TAlphaVar.here _ _ _))))))))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0060 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0061 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0058 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0059 0)) (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) (by decide)) (freshVar_injective (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) (by decide)) (TAlphaVar.here _ _ _)))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0064 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0065 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0062 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0063 0)) (TAlphaVar.here _ _ _)))))))))))))))) (TAlphaClass.refl_of_reflOn [(alpha_dummy_062, alpha_dummy_065), (alpha_dummy_061, alpha_dummy_064), (alpha_dummy_060, alpha_dummy_063), (alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_080, alpha_dummy_081), (alpha_dummy_078, alpha_dummy_079), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_076, alpha_dummy_077), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (syn_c0) wpp_refl_0011)) (TAlphaWff.neg (TAlphaWff.classEq (TAlphaClass.cv (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) (by decide)) (freshVar_injective (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) (by decide)) (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) (by decide)) (freshVar_injective (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) (by decide)) (TAlphaVar.here _ _ _)))) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0068 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0069 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0066 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0067 0)) (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) (by decide)) (freshVar_injective (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) (by decide)) (TAlphaVar.here _ _ _)))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0068 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0069 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0066 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0067 0)) (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_054)).fv ∪ ((syn_c1c)).fv) (by decide)) (freshVar_injective (((Class.cv alpha_dummy_056)).fv ∪ ((syn_c1c)).fv) (by decide)) (TAlphaVar.here _ _ _)))))))))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0072 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0073 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0070 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0071 0)) (TAlphaVar.here _ _ _))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0072 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0073 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0070 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0071 0)) (TAlphaVar.here _ _ _)))))))))))))))))))
  have wpp_notmem_0184 : alpha_dummy_076 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0185 : alpha_dummy_077 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0186 : alpha_dummy_078 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0187 : alpha_dummy_079 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0188 : alpha_dummy_080 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_notmem_0189 : alpha_dummy_081 ∉ ((syn_cnnc)).fv := by
    exact (fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_cnnc) ▸ h_mem))
  have wpp_refl_0012 : TReflOn [(alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_080, alpha_dummy_081), (alpha_dummy_078, alpha_dummy_079), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_076, alpha_dummy_077), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] ((syn_cnnc)).fv := by
    intro u hu
  ...
  have split_alpha_0008 : TAlphaWff [(alpha_dummy_055, alpha_dummy_057), (alpha_dummy_080, alpha_dummy_081), (alpha_dummy_078, alpha_dummy_079), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_076, alpha_dummy_077), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (Wff.all alpha_dummy_054 (Wff.neg (syn_wa (Wff.classMem (Class.cv alpha_dummy_054) (Class.cv alpha_dummy_047)) (Wff.classEq (Class.cv alpha_dummy_055) (syn_cif (Wff.classMem (Class.cv alpha_dummy_054) (syn_cnnc)) (syn_cplc (Class.cv alpha_dummy_054) (syn_c1c)) (Class.cv alpha_dummy_054)))))) (Wff.all alpha_dummy_056 (Wff.neg (syn_wa (Wff.classMem (Class.cv alpha_dummy_056) (Class.cv alpha_dummy_049)) (Wff.classEq (Class.cv alpha_dummy_057) (syn_cif (Wff.classMem (Class.cv alpha_dummy_056) (syn_cnnc)) (syn_cplc (Class.cv alpha_dummy_056) (syn_c1c)) (Class.cv alpha_dummy_056)))))) :=
    (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0052 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0053 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0052 1)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0053 1)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0082 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0083 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0080 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0081 0)) (TAlphaVar.here _ _ _))))))) (TAlphaWff.neg (TAlphaWff.classEq (TAlphaClass.cv (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_047)).fv) (by decide)) (freshVar_injective (((Class.cv alpha_dummy_049)).fv) (by decide)) (TAlphaVar.here _ _ _))) (TAlphaClass.cab (TAlphaWff.imp (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0056 1)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0057 1)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0056 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0057 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0054 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0055 0)) (TAlphaVar.here _ _ _)))))) (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.refl_of_reflOn [(alpha_dummy_062, alpha_dummy_065), (alpha_dummy_061, alpha_dummy_064), (alpha_dummy_060, alpha_dummy_063), (alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_080, alpha_dummy_081), (alpha_dummy_078, alpha_dummy_079), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_076, alpha_dummy_077), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (syn_c1c) wpp_refl_0010)) (TAlphaWff.neg (TAlphaWff.neg split_alpha_0007))))))))))))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0054 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0055 0)) (TAlphaVar.here _ _ _))) (TAlphaClass.refl_of_reflOn [(alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_080, alpha_dummy_081), (alpha_dummy_078, alpha_dummy_079), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_076, alpha_dummy_077), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (syn_cnnc) wpp_refl_0012)))))) (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0054 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0055 0)) (TAlphaVar.here _ _ _)))) (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0054 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0055 0)) (TAlphaVar.here _ _ _))) (TAlphaClass.refl_of_reflOn [(alpha_dummy_058, alpha_dummy_059), (alpha_dummy_054, alpha_dummy_056), (alpha_dummy_055, alpha_dummy_057), (alpha_dummy_080, alpha_dummy_081), (alpha_dummy_078, alpha_dummy_079), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_076, alpha_dummy_077), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (syn_cnnc) wpp_refl_0012))))))))))))))
  ...
  have wpp_notmem_0193 : w ∉ ((syn_ccompl (syn_csn (syn_c0c)))).fv := by
    exact (fun h_mem => ((fun h_mem => ((fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0c) ▸ h_mem))) ((fv_syn_csn (syn_c0c)) ▸ h_mem))) ((fv_syn_ccompl (syn_csn (syn_c0c))) ▸ h_mem))
  have wpp_notmem_0194 : alpha_dummy_050 ∉ ((syn_ccompl (syn_csn (syn_c0c)))).fv := by
    exact (fun h_mem => ((fun h_mem => ((fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0c) ▸ h_mem))) ((fv_syn_csn (syn_c0c)) ▸ h_mem))) ((fv_syn_ccompl (syn_csn (syn_c0c))) ▸ h_mem))
  have wpp_notmem_0195 : alpha_dummy_051 ∉ ((syn_ccompl (syn_csn (syn_c0c)))).fv := by
    exact (fun h_mem => ((fun h_mem => ((fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0c) ▸ h_mem))) ((fv_syn_csn (syn_c0c)) ▸ h_mem))) ((fv_syn_ccompl (syn_csn (syn_c0c))) ▸ h_mem))
  have wpp_notmem_0196 : alpha_dummy_076 ∉ ((syn_ccompl (syn_csn (syn_c0c)))).fv := by
    exact (fun h_mem => ((fun h_mem => ((fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0c) ▸ h_mem))) ((fv_syn_csn (syn_c0c)) ▸ h_mem))) ((fv_syn_ccompl (syn_csn (syn_c0c))) ▸ h_mem))
  have wpp_notmem_0197 : alpha_dummy_077 ∉ ((syn_ccompl (syn_csn (syn_c0c)))).fv := by
    exact (fun h_mem => ((fun h_mem => ((fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0c) ▸ h_mem))) ((fv_syn_csn (syn_c0c)) ▸ h_mem))) ((fv_syn_ccompl (syn_csn (syn_c0c))) ▸ h_mem))
  have wpp_notmem_0198 : alpha_dummy_046 ∉ ((syn_ccompl (syn_csn (syn_c0c)))).fv := by
    exact (fun h_mem => ((fun h_mem => ((fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0c) ▸ h_mem))) ((fv_syn_csn (syn_c0c)) ▸ h_mem))) ((fv_syn_ccompl (syn_csn (syn_c0c))) ▸ h_mem))
  have wpp_notmem_0199 : alpha_dummy_048 ∉ ((syn_ccompl (syn_csn (syn_c0c)))).fv := by
    exact (fun h_mem => ((fun h_mem => ((fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0c) ▸ h_mem))) ((fv_syn_csn (syn_c0c)) ▸ h_mem))) ((fv_syn_ccompl (syn_csn (syn_c0c))) ▸ h_mem))
  have wpp_notmem_0200 : alpha_dummy_047 ∉ ((syn_ccompl (syn_csn (syn_c0c)))).fv := by
    exact (fun h_mem => ((fun h_mem => ((fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0c) ▸ h_mem))) ((fv_syn_csn (syn_c0c)) ▸ h_mem))) ((fv_syn_ccompl (syn_csn (syn_c0c))) ▸ h_mem))
  have wpp_notmem_0201 : alpha_dummy_049 ∉ ((syn_ccompl (syn_csn (syn_c0c)))).fv := by
    exact (fun h_mem => ((fun h_mem => ((fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0c) ▸ h_mem))) ((fv_syn_csn (syn_c0c)) ▸ h_mem))) ((fv_syn_ccompl (syn_csn (syn_c0c))) ▸ h_mem))
  have wpp_notmem_0202 : alpha_dummy_078 ∉ ((syn_ccompl (syn_csn (syn_c0c)))).fv := by
    exact (fun h_mem => ((fun h_mem => ((fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0c) ▸ h_mem))) ((fv_syn_csn (syn_c0c)) ▸ h_mem))) ((fv_syn_ccompl (syn_csn (syn_c0c))) ▸ h_mem))
  have wpp_notmem_0203 : alpha_dummy_079 ∉ ((syn_ccompl (syn_csn (syn_c0c)))).fv := by
    exact (fun h_mem => ((fun h_mem => ((fun h_mem => ((fun h_mem => (by simpa using h_mem))) ((fv_syn_c0c) ▸ h_mem))) ((fv_syn_csn (syn_c0c)) ▸ h_mem))) ((fv_syn_ccompl (syn_csn (syn_c0c))) ▸ h_mem))
  have wpp_refl_0013 : TReflOn [(alpha_dummy_078, alpha_dummy_079), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_076, alpha_dummy_077), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] ((syn_ccompl (syn_csn (syn_c0c)))).fv := by
    intro u hu
  ...
  have split_alpha_0009 : TAlphaWff [(alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (Wff.imp (Wff.classMem (Class.cv alpha_dummy_050) (syn_ccompl (Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_003) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cphi (Class.cv alpha_dummy_047))))))) (Wff.neg (Wff.classMem (Class.cv alpha_dummy_050) (syn_ccompl (Class.cab alpha_dummy_046 (syn_wrex alpha_dummy_047 (Class.cv alpha_dummy_000) (Wff.classEq (Class.cv alpha_dummy_046) (syn_cun (syn_cphi (Class.cv alpha_dummy_047)) (syn_csn (syn_c0c)))))))))) (Wff.imp (Wff.classMem (Class.cv alpha_dummy_051) (syn_ccompl (Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv z) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cphi (Class.cv alpha_dummy_049))))))) (Wff.neg (Wff.classMem (Class.cv alpha_dummy_051) (syn_ccompl (Class.cab alpha_dummy_048 (syn_wrex alpha_dummy_049 (Class.cv w) (Wff.classEq (Class.cv alpha_dummy_048) (syn_cun (syn_cphi (Class.cv alpha_dummy_049)) (syn_csn (syn_c0c)))))))))) :=
    (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg split_alpha_0006)))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg split_alpha_0006)))))))))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0074 1)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0076 1)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0074 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0076 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0078 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0079 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0075 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0077 0)) (TAlphaVar.here _ _ _))))))) (TAlphaWff.neg (TAlphaWff.classEq (TAlphaClass.cv (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_003)).fv ∪ ((Class.cv alpha_dummy_000)).fv) (by decide)) (freshVar_injective (((Class.cv z)).fv ∪ ((Class.cv w)).fv) (by decide)) (TAlphaVar.here _ _ _))) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg split_alpha_0008))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg split_alpha_0008))))))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.refl_of_reflOn [(alpha_dummy_078, alpha_dummy_079), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_076, alpha_dummy_077), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (syn_ccompl (syn_csn (syn_c0c))) wpp_refl_0013)))))))))))))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0074 1)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0076 1)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0074 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0076 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0078 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0079 0)) (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0075 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0077 0)) (TAlphaVar.here _ _ _))))))) (TAlphaWff.neg (TAlphaWff.classEq (TAlphaClass.cv (TAlphaVar.there (freshVar_injective (((Class.cv alpha_dummy_003)).fv ∪ ((Class.cv alpha_dummy_000)).fv) (by decide)) (freshVar_injective (((Class.cv z)).fv ∪ ((Class.cv w)).fv) (by decide)) (TAlphaVar.here _ _ _))) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg split_alpha_0008))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cab (TAlphaWff.neg split_alpha_0008))))))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.refl_of_reflOn [(alpha_dummy_078, alpha_dummy_079), (alpha_dummy_047, alpha_dummy_049), (alpha_dummy_046, alpha_dummy_048), (alpha_dummy_076, alpha_dummy_077), (alpha_dummy_050, alpha_dummy_051), (alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (syn_ccompl (syn_csn (syn_c0c))) wpp_refl_0013))))))))))))))))))))))))
  ...
  have focused_notmem_0001 : alpha_dummy_003 ∉ A.fv := by
    ...
    exact NFChoice.DefinitionLeaves.AlphaFocusedSupport.freshVar_not_mem_of_subset 3 (fun u hu => hu)
  have focused_notmem_0002 : alpha_dummy_004 ∉ A.fv := by
    change freshVar (({alpha_dummy_001} : Finset Var) ∪ ({alpha_dummy_002} : Finset Var) ∪ ((syn_wex alpha_dummy_003 (syn_wex alpha_dummy_000 (syn_w3a (Wff.classEq (Class.cv alpha_dummy_001) (syn_csn (Class.cv alpha_dummy_003))) (Wff.classEq (Class.cv alpha_dummy_002) (syn_csn (Class.cv alpha_dummy_000))) (syn_wbr (Class.cv alpha_dummy_003) A (Class.cv alpha_dummy_000)))))).fv) 0 ∉ A.fv
    exact NFChoice.DefinitionLeaves.AlphaFocusedSupport.freshVar_not_mem_of_subset 0 (fun u hu => Finset.mem_union_right _ (((fv_syn_wex alpha_dummy_003 (syn_wex alpha_dummy_000 (syn_w3a (Wff.classEq (Class.cv alpha_dummy_001) (syn_csn (Class.cv alpha_dummy_003))) (Wff.classEq (Class.cv alpha_dummy_002) (syn_csn (Class.cv alpha_dummy_000))) (syn_wbr (Class.cv alpha_dummy_003) A (Class.cv alpha_dummy_000))))).symm ▸ (Finset.mem_erase.mpr ⟨(fun h_eq => (focused_notmem_0001) (h_eq ▸ hu)), (((fv_syn_wex alpha_dummy_000 (syn_w3a (Wff.classEq (Class.cv alpha_dummy_001) (syn_csn (Class.cv alpha_dummy_003))) (Wff.classEq (Class.cv alpha_dummy_002) (syn_csn (Class.cv alpha_dummy_000))) (syn_wbr (Class.cv alpha_dummy_003) A (Class.cv alpha_dummy_000)))).symm ▸ (Finset.mem_erase.mpr ⟨(fun h_eq => (focused_notmem_0000) (h_eq ▸ hu)), (((fv_syn_w3a (Wff.classEq (Class.cv alpha_dummy_001) (syn_csn (Class.cv alpha_dummy_003))) (Wff.classEq (Class.cv alpha_dummy_002) (syn_csn (Class.cv alpha_dummy_000))) (syn_wbr (Class.cv alpha_dummy_003) A (Class.cv alpha_dummy_000))).symm ▸ (Finset.mem_union_left _ (Finset.mem_union_left _ (((fv_syn_wbr (Class.cv alpha_dummy_003) A (Class.cv alpha_dummy_000)).symm ▸ (Finset.mem_union_right _ (hu))))))))⟩)))⟩))))
  have wpp_notmem_0204 : alpha_dummy_004 ∉ (A).fv := by
    exact focused_notmem_0002
  have focused_notmem_0003 : alpha_dummy_005 ∉ A.fv := by
    change freshVar (({x} : Finset Var) ∪ ({y} : Finset Var) ∪ ((syn_wex z (syn_wex w (syn_w3a (Wff.classEq (Class.cv x) (syn_csn (Class.cv z))) (Wff.classEq (Class.cv y) (syn_csn (Class.cv w))) (syn_wbr (Class.cv z) A (Class.cv w)))))).fv) 0 ∉ A.fv
    exact NFChoice.DefinitionLeaves.AlphaFocusedSupport.freshVar_not_mem_of_subset 0 (fun u hu => Finset.mem_union_right _ (((fv_syn_wex z (syn_wex w (syn_w3a (Wff.classEq (Class.cv x) (syn_csn (Class.cv z))) (Wff.classEq (Class.cv y) (syn_csn (Class.cv w))) (syn_wbr (Class.cv z) A (Class.cv w))))).symm ▸ (Finset.mem_erase.mpr ⟨(fun h_eq => (dv_A_z) (h_eq ▸ hu)), (((fv_syn_wex w (syn_w3a (Wff.classEq (Class.cv x) (syn_csn (Class.cv z))) (Wff.classEq (Class.cv y) (syn_csn (Class.cv w))) (syn_wbr (Class.cv z) A (Class.cv w)))).symm ▸ (Finset.mem_erase.mpr ⟨(fun h_eq => (dv_A_w) (h_eq ▸ hu)), (((fv_syn_w3a (Wff.classEq (Class.cv x) (syn_csn (Class.cv z))) (Wff.classEq (Class.cv y) (syn_csn (Class.cv w))) (syn_wbr (Class.cv z) A (Class.cv w))).symm ▸ (Finset.mem_union_left _ (Finset.mem_union_left _ (((fv_syn_wbr (Class.cv z) A (Class.cv w)).symm ▸ (Finset.mem_union_right _ (hu))))))))⟩)))⟩))))
  have wpp_notmem_0205 : alpha_dummy_005 ∉ (A).fv := by
    exact focused_notmem_0003
  have focused_notmem_0004 : alpha_dummy_001 ∉ A.fv := by
    change freshVar ((A).fv) 1 ∉ A.fv
    exact NFChoice.DefinitionLeaves.AlphaFocusedSupport.freshVar_not_mem_of_subset 1 (fun u hu => hu)
  have wpp_notmem_0206 : alpha_dummy_001 ∉ (A).fv := by
    exact focused_notmem_0004
  have wpp_notmem_0207 : x ∉ (A).fv := by
    exact dv_A_x
  have focused_notmem_0005 : alpha_dummy_002 ∉ A.fv := by
    change freshVar ((A).fv) 2 ∉ A.fv
    exact NFChoice.DefinitionLeaves.AlphaFocusedSupport.freshVar_not_mem_of_subset 2 (fun u hu => hu)
  have wpp_notmem_0208 : alpha_dummy_002 ∉ (A).fv := by
    exact focused_notmem_0005
  have wpp_notmem_0209 : y ∉ (A).fv := by
    exact dv_A_y
  have wpp_notmem_0210 : alpha_dummy_003 ∉ (A).fv := by
    exact focused_notmem_0001
  have wpp_notmem_0211 : z ∉ (A).fv := by
    exact dv_A_z
  have wpp_notmem_0212 : alpha_dummy_000 ∉ (A).fv := by
    exact focused_notmem_0000
  have wpp_notmem_0213 : w ∉ (A).fv := by
    exact dv_A_w
  have wpp_refl_0014 : TReflOn [(alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] (A).fv := by
    intro u hu
    exact (TAlphaVar.there (fun h_eq => (wpp_notmem_0212) (h_eq ▸ hu)) (fun h_eq => (wpp_notmem_0213) (h_eq ▸ hu)) (TAlphaVar.there (fun h_eq => (wpp_notmem_0210) (h_eq ▸ hu)) (fun h_eq => (wpp_notmem_0211) (h_eq ▸ hu)) (TAlphaVar.there (fun h_eq => (wpp_notmem_0208) (h_eq ▸ hu)) (fun h_eq => (wpp_notmem_0209) (h_eq ▸ hu)) (TAlphaVar.there (fun h_eq => (wpp_notmem_0206) (h_eq ▸ hu)) (fun h_eq => (wpp_notmem_0207) (h_eq ▸ hu)) (TAlphaVar.there (fun h_eq => (wpp_notmem_0204) (h_eq ▸ hu)) (fun h_eq => (wpp_notmem_0205) (h_eq ▸ hu)) (TAlphaVar.free (by simp) (by simp)))))))
  exact Nominal.alphaClassEq (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp split_alpha_0004 (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.all (TAlphaWff.neg (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.neg (TAlphaWff.imp (TAlphaWff.classEq (TAlphaClass.cv (TAlphaVar.there (freshVar_injective ((A).fv) (by decide)) (Ne.symm dv_w_x) (TAlphaVar.there (freshVar_injective ((A).fv) (by decide)) dv_x_z (TAlphaVar.there (freshVar_injective ((A).fv) (by decide)) dv_x_y (TAlphaVar.here _ _ _))))) (TAlphaClass.cab (TAlphaWff.classEq (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0042 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0043 0)) (TAlphaVar.there (freshVar_injective ((A).fv) (by decide)) (Ne.symm dv_w_z) (TAlphaVar.here _ _ _))))))) (TAlphaWff.neg (TAlphaWff.classEq (TAlphaClass.cv (TAlphaVar.there (freshVar_injective ((A).fv) (by decide)) (Ne.symm dv_w_y) (TAlphaVar.there (freshVar_injective ((A).fv) (by decide)) dv_y_z (TAlphaVar.here _ _ _)))) (TAlphaClass.cab (TAlphaWff.classEq (TAlphaClass.cv (TAlphaVar.here _ _ _)) (TAlphaClass.cv (TAlphaVar.there (Nat.ne_of_lt (mem_lt_freshVar support_mem_0044 0)) (Nat.ne_of_lt (mem_lt_freshVar support_mem_0045 0)) (TAlphaVar.here _ _ _))))))))) (TAlphaWff.neg (TAlphaWff.classMem (TAlphaClass.cab (TAlphaWff.neg (TAlphaWff.neg split_alpha_0009))) (TAlphaClass.refl_of_reflOn [(alpha_dummy_000, w), (alpha_dummy_003, z), (alpha_dummy_002, y), (alpha_dummy_001, x), (alpha_dummy_004, alpha_dummy_005)] A wpp_refl_0014)))))))))))))))))))))

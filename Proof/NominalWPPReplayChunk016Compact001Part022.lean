...
import NominalWPPReplayChunk016Compact001Part021
...
noncomputable def g_wecutisossgen
    (D : Class) (R : Class) (S : Class) (E : Class) (hyp_wecutisossgen_1 : Nominal.NPrf (syn_wbr R (syn_cwe) D)) (hyp_wecutisossgen_2 : Nominal.NPrf (syn_wbr S (syn_cwe) E)) :
    Nominal.NPrf (syn_wss (syn_cwecutiso R D S E) (syn_cwecutisogen R D S E)) := by
  ...
  have dv_cache_0016 : x ∉ ((Wff.classMem (.cv f) (syn_cwecutisogen R D S E))).fv := by
  ...
  have dv_cache_0017 : y ∉ ((Wff.classMem (.cv f) (syn_cwecutisogen R D S E))).fv := by
  ...
  have dv_cache_0019 : f ∉ ((syn_cwecutiso R D S E)).fv := by
  ...
  have dv_cache_0020 : f ∉ ((syn_cwecutisogen R D S E)).fv := by
  ...
  have p0001 :=
    @g_biimpi (.classMem (.cv f) (syn_cwecutiso R D S E)) (syn_wrex x D (syn_wrex y E (syn_wiso (.cv f) (syn_cin R (syn_cxp (syn_cin D (syn_cima (syn_ccnv (syn_cdif R (syn_cid))) (syn_csn (.cv x)))) (syn_cin D (syn_cima (syn_ccnv (syn_cdif R (syn_cid))) (syn_csn (.cv x)))))) (syn_cin S (syn_cxp (syn_cin E (syn_cima (syn_ccnv (syn_cdif S (syn_cid))) (syn_csn (.cv y)))) (syn_cin E (syn_cima (syn_ccnv (syn_cdif S (syn_cid))) (syn_csn (.cv y)))))) (syn_cin D (syn_cima (syn_ccnv (syn_cdif R (syn_cid))) (syn_csn (.cv x)))) (syn_cin E (syn_cima (syn_ccnv (syn_cdif S (syn_cid))) (syn_csn (.cv y))))))) p0000
  have p0002 :=
    @g_wecutisogenfixedfwd x y D R S f E dv_cache_0012 dv_cache_0002 dv_cache_0013 dv_cache_0003 dv_cache_0014 dv_cache_0006 dv_cache_0015 dv_cache_0007 dv_cache_0010 dv_cache_0009 hyp_wecutisossgen_1 hyp_wecutisossgen_2
  have p0003 :=
    @g_ex (syn_wa (.classMem (.cv x) D) (.classMem (.cv y) E)) (syn_wiso (.cv f) (syn_cin R (syn_cxp (syn_cin D (syn_cima (syn_ccnv (syn_cdif R (syn_cid))) (syn_csn (.cv x)))) (syn_cin D (syn_cima (syn_ccnv (syn_cdif R (syn_cid))) (syn_csn (.cv x)))))) (syn_cin S (syn_cxp (syn_cin E (syn_cima (syn_ccnv (syn_cdif S (syn_cid))) (syn_csn (.cv y)))) (syn_cin E (syn_cima (syn_ccnv (syn_cdif S (syn_cid))) (syn_csn (.cv y)))))) (syn_cin D (syn_cima (syn_ccnv (syn_cdif R (syn_cid))) (syn_csn (.cv x)))) (syn_cin E (syn_cima (syn_ccnv (syn_cdif S (syn_cid))) (syn_csn (.cv y))))) (.classMem (.cv f) (syn_cwecutisogen R D S E)) p0002
  have p0004 :=
    @g_rexlimivv (syn_wiso (.cv f) (syn_cin R (syn_cxp (syn_cin D (syn_cima (syn_ccnv (syn_cdif R (syn_cid))) (syn_csn (.cv x)))) (syn_cin D (syn_cima (syn_ccnv (syn_cdif R (syn_cid))) (syn_csn (.cv x)))))) (syn_cin S (syn_cxp (syn_cin E (syn_cima (syn_ccnv (syn_cdif S (syn_cid))) (syn_csn (.cv y)))) (syn_cin E (syn_cima (syn_ccnv (syn_cdif S (syn_cid))) (syn_csn (.cv y)))))) (syn_cin D (syn_cima (syn_ccnv (syn_cdif R (syn_cid))) (syn_csn (.cv x)))) (syn_cin E (syn_cima (syn_ccnv (syn_cdif S (syn_cid))) (syn_csn (.cv y))))) (.classMem (.cv f) (syn_cwecutisogen R D S E)) x y D E dv_cache_0001 dv_cache_0016 dv_cache_0017 dv_cache_0018 p0003
  have p0005 :=
    @g_syl (.classMem (.cv f) (syn_cwecutiso R D S E)) (syn_wrex x D (syn_wrex y E (syn_wiso (.cv f) (syn_cin R (syn_cxp (syn_cin D (syn_cima (syn_ccnv (syn_cdif R (syn_cid))) (syn_csn (.cv x)))) (syn_cin D (syn_cima (syn_ccnv (syn_cdif R (syn_cid))) (syn_csn (.cv x)))))) (syn_cin S (syn_cxp (syn_cin E (syn_cima (syn_ccnv (syn_cdif S (syn_cid))) (syn_csn (.cv y)))) (syn_cin E (syn_cima (syn_ccnv (syn_cdif S (syn_cid))) (syn_csn (.cv y)))))) (syn_cin D (syn_cima (syn_ccnv (syn_cdif R (syn_cid))) (syn_csn (.cv x)))) (syn_cin E (syn_cima (syn_ccnv (syn_cdif S (syn_cid))) (syn_csn (.cv y))))))) (.classMem (.cv f) (syn_cwecutisogen R D S E)) p0001 p0004
  have p0006 :=
    @g_ssriv f (syn_cwecutiso R D S E) (syn_cwecutisogen R D S E) dv_cache_0019 dv_cache_0020 p0005
  exact p0006

#print axioms g_wecutisossgen
